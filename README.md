...
* **[Yara](https://github.com/VirusTotal/yara) ⭐ 9,863 | 🐛 170 | 🌐 C | 📅 2026-08-25** - *Malware pattern matching tool.*
* **[Capa](https://github.com/mandiant/capa) ⭐ 6,181 | 🐛 299 | 🌐 Python | 📅 2026-09-08** - *Identify capabilities in executables.*
* **[PE-bear](https://github.com/hasherezade/pe-bear) ⭐ 3,800 | 🐛 16 | 🌐 C++ | 📅 2026-09-11** - *PE reversing tool.*
...
* **[Exeinfo PE (ASL)](https://github.com/ExeinfoASL/ASL) ⭐ 1,147 | 🐛 8 | 📅 2026-09-11** - *Detects packers and compressors.*
...
* **[Driver Store Explorer](https://github.com/lostindark/DriverStoreExplorer) ⭐ 11,619 | 🐛 25 | 🌐 C# | 📅 2026-09-08** - *Driver Store Explorer.*
...
* **[PacketSender](https://github.com/dannagle/PacketSender) ⭐ 2,676 | 🐛 67 | 🌐 C++ | 📅 2026-09-01** - *Send & receive TCP, UDP, SSL, DTLS. HTTP Requests.*
...
* **[SQLiteStudio](https://github.com/pawelsalawa/sqlitestudio) ⭐ 6,736 | 🐛 491 | 🌐 C | 📅 2026-08-24** - *SQLite database manager.*
* **[GrepWin (Text)](https://github.com/stefankueng/grepWin) ⭐ 2,068 | 🐛 48 | 🌐 C++ | 📅 2026-09-05** - *Search tool for Windows.*
* **[XMachO Viewer](https://github.com/horsicq/XMachOViewer) ⭐ 963 | 🐛 4 | 🌐 C++ | 📅 2026-09-12** - *Mac OS XMachO Viewer.*
...
* **[CyberChef](https://github.com/gchq/CyberChef) ⭐ 35,817 | 🐛 585 | 🌐 JavaScript | 📅 2026-09-11** - *Analyzing and decoding data.*
...
* **[UEFITool](https://github.com/LongSoft/UEFITool) ⭐ 5,667 | 🐛 23 | 🌐 C | 📅 2026-07-29** - *UEFI firmware image viewer and editor.*
...
* **[x64dbg](https://github.com/x64dbg/x64dbg) ⭐ 49,494 | 🐛 581 | 🌐 C++ | 📅 2026-09-10** - *Graphical debugger for x86 and x86-64 executables.*
* **[dnSpy](https://github.com/dnSpy/dnSpy) ⚠️ Archived** - *.NET assembly editor, decompiler, and debugger.*
* **[Radare2](https://github.com/radareorg/radare2) ⭐ 24,786 | 🐛 821 | 🌐 C | 📅 2026-09-12** - *A portable and multi-architecture reverse engineering framework.*
* **[Cutter](https://github.com/rizinorg/cutter) ⭐ 19,717 | 🐛 493 | 🌐 C++ | 📅 2026-09-11** - *Free and open-source reverse engineering platform.*
...
* **[Ghidra](https://github.com/NationalSecurityAgency/ghidra) ⭐ 74,878 | 🐛 1,943 | 🌐 Java | 📅 2026-09-11** - *Open-source software reverse engineering suite.*
* **[Capstone](https://github.com/capstone-engine/capstone) ⭐ 9,012 | 🐛 358 | 🌐 C | 📅 2026-09-10** - *Lightweight multi-architecture disassembly framework.*
* **[WABT](https://github.com/WebAssembly/wabt) ⭐ 8,126 | 🐛 241 | 🌐 C++ | 📅 2026-09-06** - *WebAssembly Binary Toolkit - disassembler and tools.*
...
* **[JADX](https://github.com/skylot/jadx) ⭐ 50,442 | 🐛 444 | 🌐 Java | 📅 2026-09-12** - *Dex to Java decompiler.*
* **[ILSpy](https://github.com/icsharpcode/ILSpy) ⭐ 26,059 | 🐛 172 | 🌐 C# | 📅 2026-09-12** - *Open-source .NET assembly browser.*
* **[Bytecode Viewer](https://github.com/Konloch/bytecode-viewer) ⭐ 15,639 | 🐛 103 | 🌐 Java | 📅 2026-07-17** - *Decompile Java/Android bytecode & more.*
* **[JD-GUI](https://github.com/java-decompiler/jd-gui) ⭐ 15,202 | 🐛 248 | 🌐 Java | 📅 2024-07-08** - *Decompile Java class files.*
* **[FFDec](https://github.com/jindrapetrik/jpexs-decompiler) ⭐ 5,865 | 🐛 2 | 🌐 Java | 📅 2026-09-12** - *Flash Decompiler.*
...
* **[ImHex](https://github.com/WerWolv/ImHex) ⭐ 54,784 | 🐛 401 | 🌐 C++ | 📅 2026-09-11** - *A fast and powerful hex editor.*
...
* **[Frida](https://github.com/frida/frida) ⭐ 21,907 | 🐛 1,962 | 🌐 Meson | 📅 2026-09-09** - *Dynamic instrumentation toolkit.*
* **[Cheat Engine](https://github.com/cheat-engine/cheat-engine) ⭐ 19,169 | 🐛 1,309 | 🌐 Pascal | 📅 2025-04-19** - *Memory scanner/debugger for games and applications.*
* **[ReClass.NET](https://github.com/ReClassNET/ReClass.NET) ⭐ 2,199 | 🐛 84 | 🌐 C# | 📅 2024-05-10** - *.Net structure class reverser.*
* **[XELFViewer](https://github.com/horsicq/XELFViewer) ⭐ 1,585 | 🐛 8 | 🌐 C++ | 📅 2026-09-12** - *ELF files viewer and editor.*
* **[Scylla](https://github.com/NtQuery/Scylla) ⭐ 1,428 | 🐛 23 | 🌐 C++ | 📅 2023-04-05** - *Powerful and advanced x86/x86-64 executable unpacker.*
* **[XPEViewer](https://github.com/horsicq/XPEViewer) ⭐ 1,233 | 🐛 5 | 🌐 QMake | 📅 2026-09-12** - *Executable file viewer and editor.*
* **[PE Tools](https://github.com/petoolse/petools) ⭐ 1,198 | 🐛 10 | 📅 2025-10-21** - *PE manipulation toolkit.*
...
* **[Exiftool](https://github.com/exiftool/exiftool) ⭐ 5,030 | 🐛 42 | 🌐 Perl | 📅 2026-05-27** - *Meta data editor.*
...
* **[WinSCP](https://github.com/winscp/winscp) ⭐ 3,830 | 🐛 1 | 🌐 C | 📅 2026-09-12** - *Free SFTP, SCP, and FTP client for Windows.*
...
* **[MilkyTracker](https://github.com/milkytracker/MilkyTracker) ⭐ 2,098 | 🐛 87 | 🌐 C++ | 📅 2026-09-10** - *Multi-platform music tracker inspired by FastTracker 2.*
* **[OpenMPT](https://github.com/OpenMPT/openmpt) ⭐ 773 | 🐛 3 | 🌐 C++ | 📅 2026-08-29** - *Open-source tracker software.*
...
* **[Nasm](https://github.com/netwide-assembler/nasm) ⭐ 3,312 | 🐛 71 | 🌐 Assembly | 📅 2026-08-19** - *Netwide Assembler for x86 architecture.*
...
* **[UPX](https://github.com/upx/upx) ⭐ 17,866 | 🐛 23 | 🌐 C++ | 📅 2026-09-12** - *Free, portable, and extendable executable packer.*
...
* **[Etcher](https://github.com/balena-io/etcher) ⭐ 34,332 | 🐛 690 | 🌐 TypeScript | 📅 2026-06-02** - *A cross-platform tool to flash OS images onto SD cards and USB.*
...
* **[Apktool](https://github.com/iBotPeaches/Apktool) ⭐ 25,544 | 🐛 77 | 🌐 Java | 📅 2026-09-04** - *Tool for decompiling and recompiling Android APK files.*
* **[APK Editor Studio](https://github.com/kefir500/apk-editor-studio) ⭐ 1,658 | 🐛 55 | 🌐 C++ | 📅 2025-01-19** - *Powerful APK editing tool.*
* **[Bifrost](https://github.com/zacharee/Bifrost) ⭐ 1,599 | 🐛 7 | 🌐 Kotlin | 📅 2026-09-05** - *Tool for downloading Samsung mobile device firmware.*
...
* **[SysDVR](https://github.com/exelix11/SysDVR) ⭐ 2,019 | 🐛 12 | 🌐 C++ | 📅 2026-07-16** - *Nintendo Switch streaming client.*
* **[Switch LAN Play](https://github.com/spacemeowx2/switch-lan-play) ⭐ 2,015 | 🐛 62 | 🌐 C | 📅 2025-03-21** - *Nintendo Switch LAN client.*
* **[Appstore](https://github.com/fortheusers/hb-appstore) ⭐ 1,458 | 🐛 27 | 🌐 C++ | 📅 2026-07-08** - *GUI Homebrew app store for CFW.*
...
* **[Logisim](https://github.com/logisim-evolution/logisim-evolution) ⭐ 7,558 | 🐛 106 | 🌐 Java | 📅 2026-09-12** - *Educational digital circuit simulator.*
* **[Arduino CLI](https://github.com/arduino/arduino-cli) ⭐ 5,021 | 🐛 267 | 🌐 Go | 📅 2026-09-11** - *Command-line interface for Arduino.*
* **[Fritzing](https://github.com/fritzing/fritzing-app) ⭐ 4,806 | 🐛 496 | 🌐 C++ | 📅 2026-08-12** - *An open-source electronics design software.*
* **[PICSimLab](https://github.com/lcgamboa/picsimlab) ⭐ 665 | 🐛 9 | 🌐 C++ | 📅 2026-09-06** - *PIC microcontroller simulator.*
* **[SimulIDE](https://github.com/simulide/simulide) ⭐ 308 | 🐛 23 | 🌐 C++ | 📅 2021-11-04** - *Real-time electronics simulator.*
...
* **[DevToys](https://github.com/DevToys-app/DevToys) ⭐ 31,989 | 🐛 341 | 🌐 C# | 📅 2026-02-25** - *A Swiss Army knife for developers.*
* **[Cmder](https://github.com/cmderdev/cmder) ⭐ 27,010 | 🐛 67 | 🌐 PowerShell | 📅 2026-08-31** - *Console emulator.*
...
* **[Sandboxie](https://github.com/sandboxie-plus/Sandboxie) ⭐ 19,405 | 🐛 754 | 🌐 C | 📅 2026-09-06** - *Enhanced version of the popular sandboxing program.*
* **[Cmake](https://github.com/Kitware/CMake) ⭐ 8,072 | 🐛 2 | 🌐 C | 📅 2026-09-12** - *C, C++ builder.*

...
* **[Yara](https://github.com/VirusTotal/yara) ⭐ 9,817 | 🐛 171 | 🌐 C | 📅 2026-08-21** - *Malware pattern matching tool.*
...
* **[Detect It Easy (DiE)](https://github.com/horsicq/DIE-engine) ⭐ 3,231 | 🐛 14 | 🌐 C++ | 📅 2026-08-22** - *File type identifier.*
...
* **[Driver Store Explorer](https://github.com/lostindark/DriverStoreExplorer) ⭐ 11,474 | 🐛 24 | 🌐 C# | 📅 2026-08-09** - *Driver Store Explorer.*
...
* **[PE-sieve](https://github.com/hasherezade/pe-sieve) ⭐ 3,861 | 🐛 7 | 🌐 C++ | 📅 2026-06-06** - *Scans a given process.*
...
* **[Papercut](https://github.com/ChangemakerStudios/Papercut) ⭐ 3,324 | 🐛 4 | 🌐 C# | 📅 2026-08-22** - *Simple SMTP server for testing.*
...
* **[SQLiteStudio](https://github.com/pawelsalawa/sqlitestudio) ⭐ 6,715 | 🐛 489 | 🌐 C | 📅 2026-08-21** - *SQLite database manager.*
* **[GrepWin (Text)](https://github.com/stefankueng/grepWin) ⭐ 2,061 | 🐛 46 | 🌐 C++ | 📅 2026-08-21** - *Search tool for Windows.*
* **[XMachO Viewer](https://github.com/horsicq/XMachOViewer) ⭐ 959 | 🐛 4 | 🌐 C++ | 📅 2026-08-22** - *Mac OS XMachO Viewer.*
...
* **[Magicmida](https://github.com/Hendi48/Magicmida) ⭐ 692 | 🐛 18 | 🌐 Pascal | 📅 2026-05-14** - *Themida/WinLicense unpacker.*
...
* **[ASPack Unpacker](https://github.com/orcastor/unpack) ⭐ 74 | 🐛 2 | 🌐 Go | 📅 2025-12-21** - *Another ASPack unpacker.*
...
* **[CyberChef](https://github.com/gchq/CyberChef) ⭐ 35,635 | 🐛 556 | 🌐 JavaScript | 📅 2026-08-21** - *Analyzing and decoding data.*
* **[RSA-Tool 2](https://github.com/ius/rsatool) ⭐ 1,653 | 🐛 2 | 🌐 Python | 📅 2026-07-20** - *Tool for generating and analyzing RSA keys.*
* **[RSATool](https://github.com/ius/rsatool) ⭐ 1,653 | 🐛 2 | 🌐 Python | 📅 2026-07-20** - *Generate, convert and analyze RSA keys.*
...
* **[UEFITool](https://github.com/LongSoft/UEFITool) ⭐ 5,632 | 🐛 23 | 🌐 C | 📅 2026-07-29** - *UEFI firmware image viewer and editor.*
...
* **[x64dbg](https://github.com/x64dbg/x64dbg) ⭐ 49,231 | 🐛 577 | 🌐 C++ | 📅 2026-08-15** - *Graphical debugger for x86 and x86-64 executables.*
* **[dnSpy](https://github.com/dnSpy/dnSpy) ⚠️ Archived** - *.NET assembly editor, decompiler, and debugger.*
* **[Radare2](https://github.com/radareorg/radare2) ⭐ 24,620 | 🐛 818 | 🌐 C | 📅 2026-08-22** - *A portable and multi-architecture reverse engineering framework.*
* **[Cutter](https://github.com/rizinorg/cutter) ⭐ 19,514 | 🐛 493 | 🌐 C++ | 📅 2026-08-22** - *Free and open-source reverse engineering platform.*
...
* **[Ghidra](https://github.com/NationalSecurityAgency/ghidra) ⭐ 72,674 | 🐛 1,919 | 🌐 Java | 📅 2026-08-20** - *Open-source software reverse engineering suite.*
* **[Capstone](https://github.com/capstone-engine/capstone) ⭐ 8,968 | 🐛 363 | 🌐 C | 📅 2026-08-22** - *Lightweight multi-architecture disassembly framework.*
* **[WABT](https://github.com/WebAssembly/wabt) ⭐ 8,101 | 🐛 225 | 🌐 C++ | 📅 2026-08-21** - *WebAssembly Binary Toolkit - disassembler and tools.*
...
* **[JADX](https://github.com/skylot/jadx) ⭐ 50,157 | 🐛 442 | 🌐 Java | 📅 2026-08-19** - *Dex to Java decompiler.*
* **[ILSpy](https://github.com/icsharpcode/ILSpy) ⭐ 25,917 | 🐛 190 | 🌐 C# | 📅 2026-08-22** - *Open-source .NET assembly browser.*
* **[Bytecode Viewer](https://github.com/Konloch/bytecode-viewer) ⭐ 15,612 | 🐛 103 | 🌐 Java | 📅 2026-07-17** - *Decompile Java/Android bytecode & more.*
...
* **[ImHex](https://github.com/WerWolv/ImHex) ⭐ 54,535 | 🐛 389 | 🌐 C++ | 📅 2026-08-22** - *A fast and powerful hex editor.*
...
* **[Frida](https://github.com/frida/frida) ⭐ 21,695 | 🐛 1,959 | 🌐 Meson | 📅 2026-08-18** - *Dynamic instrumentation toolkit.*
* **[Cheat Engine](https://github.com/cheat-engine/cheat-engine) ⭐ 19,029 | 🐛 1,307 | 🌐 Pascal | 📅 2025-04-19** - *Memory scanner/debugger for games and applications.*
* **[ReClass.NET](https://github.com/ReClassNET/ReClass.NET) ⭐ 2,185 | 🐛 84 | 🌐 C# | 📅 2024-05-10** - *.Net structure class reverser.*
* **[XELFViewer](https://github.com/horsicq/XELFViewer) ⭐ 1,581 | 🐛 8 | 🌐 C++ | 📅 2026-08-20** - *ELF files viewer and editor.*
* **[Scylla](https://github.com/NtQuery/Scylla) ⭐ 1,417 | 🐛 23 | 🌐 C++ | 📅 2023-04-05** - *Powerful and advanced x86/x86-64 executable unpacker.*
* **[XPEViewer](https://github.com/horsicq/XPEViewer) ⭐ 1,228 | 🐛 5 | 🌐 QMake | 📅 2026-08-22** - *Executable file viewer and editor.*
...
* **[Xenos](https://github.com/DarthTon/Xenos) ⭐ 2,638 | 🐛 51 | 🌐 C++ | 📅 2021-05-17** - *DLL injector.*
...
* **[WinSCP](https://github.com/winscp/winscp) ⭐ 3,785 | 🐛 1 | 🌐 C | 📅 2026-08-22** - *Free SFTP, SCP, and FTP client for Windows.*
...
* **[OpenMPT](https://github.com/OpenMPT/openmpt) ⭐ 767 | 🐛 3 | 🌐 C++ | 📅 2026-08-19** - *Open-source tracker software.*
...
* **[Nasm](https://github.com/netwide-assembler/nasm) ⭐ 3,283 | 🐛 63 | 🌐 Assembly | 📅 2026-08-19** - *Netwide Assembler for x86 architecture.*
* **AsmEdit** - *ASM Editor.*
...
* **[ProGuard](https://github.com/Guardsquare/proguard) ⭐ 3,634 | 🐛 179 | 🌐 Java | 📅 2026-08-07** - *Java optimizer and obfuscator.*
...
* **[UPX](https://github.com/upx/upx) ⭐ 17,801 | 🐛 27 | 🌐 C++ | 📅 2026-08-22** - *Free, portable, and extendable executable packer.*
...
* **[Etcher](https://github.com/balena-io/etcher) ⭐ 34,209 | 🐛 685 | 🌐 TypeScript | 📅 2026-06-02** - *A cross-platform tool to flash OS images onto SD cards and USB.*
...
* **[Apktool](https://github.com/iBotPeaches/Apktool) ⭐ 25,345 | 🐛 77 | 🌐 Java | 📅 2026-08-22** - *Tool for decompiling and recompiling Android APK files.*
...
* **[Quark](https://github.com/XorTroll/Goldleaf) ⭐ 3,021 | 🐛 90 | 🌐 C | 📅 2026-08-20** - *Nintendo Switch games installer using Goldleaf.*
...
* **[TegraRcmGUI](https://github.com/eliboa/TegraRcmGUI) ⭐ 2,292 | 🐛 24 | 🌐 C++ | 📅 2021-11-30** - *Nintendo Switch payload injector (RCM Mode).*
* **[Switch LAN Play](https://github.com/spacemeowx2/switch-lan-play) ⭐ 2,012 | 🐛 62 | 🌐 C | 📅 2025-03-21** - *Nintendo Switch LAN client.*
* **[SysDVR](https://github.com/exelix11/SysDVR) ⭐ 2,006 | 🐛 12 | 🌐 C++ | 📅 2026-07-16** - *Nintendo Switch streaming client.*
...
* **[Logisim](https://github.com/logisim-evolution/logisim-evolution) ⭐ 7,464 | 🐛 143 | 🌐 Java | 📅 2026-08-22** - *Educational digital circuit simulator.*
* **[Arduino CLI](https://github.com/arduino/arduino-cli) ⭐ 4,997 | 🐛 262 | 🌐 Go | 📅 2026-08-20** - *Command-line interface for Arduino.*
* **[Fritzing](https://github.com/fritzing/fritzing-app) ⭐ 4,781 | 🐛 495 | 🌐 C++ | 📅 2026-08-12** - *An open-source electronics design software.*
...
* **[DevToys](https://github.com/DevToys-app/DevToys) ⭐ 31,880 | 🐛 338 | 🌐 C# | 📅 2026-02-25** - *A Swiss Army knife for developers.*
* **[Cmder](https://github.com/cmderdev/cmder) ⭐ 26,988 | 🐛 67 | 🌐 PowerShell | 📅 2026-08-21** - *Console emulator.*
...
* **[Sandboxie](https://github.com/sandboxie-plus/Sandboxie) ⭐ 19,219 | 🐛 740 | 🌐 C | 📅 2026-08-22** - *Enhanced version of the popular sandboxing program.*
* **[Cmake](https://github.com/Kitware/CMake) ⭐ 8,040 | 🐛 2 | 🌐 C | 📅 2026-08-22** - *C, C++ builder.*

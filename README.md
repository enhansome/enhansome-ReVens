...
* Download latest ReVens from: [Releases](https://github.com/Jakiboy/ReVens/releases) ⭐ 357 | 🐛 0 | 🌐 JavaScript | 📅 2026-05-23.
...
* **[Yara](https://github.com/VirusTotal/yara) ⭐ 9,868 | 🐛 170 | 🌐 C | 📅 2026-08-25** - *Malware pattern matching tool.*
* **[Capa](https://github.com/mandiant/capa) ⭐ 6,181 | 🐛 299 | 🌐 Python | 📅 2026-09-08** - *Identify capabilities in executables.*
* **[PE-bear](https://github.com/hasherezade/pe-bear) ⭐ 3,801 | 🐛 16 | 🌐 C++ | 📅 2026-09-11** - *PE reversing tool.*
...
* **[Detect It Easy (DiE)](https://github.com/horsicq/DIE-engine) ⭐ 3,264 | 🐛 13 | 🌐 C++ | 📅 2026-09-11** - *File type identifier.*
...
* **[Exeinfo PE (ASL)](https://github.com/ExeinfoASL/ASL) ⭐ 1,148 | 🐛 8 | 📅 2026-09-11** - *Detects packers and compressors.*
...
* **[Driver Store Explorer](https://github.com/lostindark/DriverStoreExplorer) ⭐ 11,628 | 🐛 25 | 🌐 C# | 📅 2026-09-08** - *Driver Store Explorer.*
...
* **[PacketSender](https://github.com/dannagle/PacketSender) ⭐ 2,677 | 🐛 67 | 🌐 C++ | 📅 2026-09-13** - *Send & receive TCP, UDP, SSL, DTLS. HTTP Requests.*
* **[HTTP Toolkit](https://github.com/httptoolkit/httptoolkit-desktop) ⭐ 729 | 🐛 18 | 🌐 TypeScript | 📅 2026-09-11** - *Intercept, view & edit any HTTP traffic.*
...
* **[SQLiteStudio](https://github.com/pawelsalawa/sqlitestudio) ⭐ 6,737 | 🐛 490 | 🌐 C | 📅 2026-08-24** - *SQLite database manager.*
* **[GrepWin (Text)](https://github.com/stefankueng/grepWin) ⭐ 2,068 | 🐛 48 | 🌐 C++ | 📅 2026-09-05** - *Search tool for Windows.*
* **[XMachO Viewer](https://github.com/horsicq/XMachOViewer) ⭐ 963 | 🐛 4 | 🌐 C++ | 📅 2026-09-13** - *Mac OS XMachO Viewer.*
...
* **[MalUnpack](https://github.com/hasherezade/mal_unpack) ⭐ 839 | 🐛 1 | 🌐 C | 📅 2026-04-14** - *Dynamic unpacker for malware analysis.*
...
* **[CyberChef](https://github.com/gchq/CyberChef) ⭐ 35,827 | 🐛 593 | 🌐 JavaScript | 📅 2026-09-11** - *Analyzing and decoding data.*
...
* **[UEFITool](https://github.com/LongSoft/UEFITool) ⭐ 5,672 | 🐛 23 | 🌐 C | 📅 2026-07-29** - *UEFI firmware image viewer and editor.*
* **[UniExtract](https://github.com/Bioruebe/UniExtract2) ⭐ 4,418 | 🐛 123 | 🌐 AutoIt | 📅 2024-07-06** - *Universal archive extractor.*
...
* **[LessMSI](https://github.com/activescott/lessmsi) ⭐ 1,762 | 🐛 55 | 🌐 C# | 📅 2026-04-02** - *Command-line tool to extract data from MSI files.*
...
* **[x64dbg](https://github.com/x64dbg/x64dbg) ⭐ 49,497 | 🐛 585 | 🌐 C++ | 📅 2026-09-14** - *Graphical debugger for x86 and x86-64 executables.*
* **[dnSpy](https://github.com/dnSpy/dnSpy) ⚠️ Archived** - *.NET assembly editor, decompiler, and debugger.*
* **[Radare2](https://github.com/radareorg/radare2) ⭐ 24,792 | 🐛 822 | 🌐 C | 📅 2026-09-13** - *A portable and multi-architecture reverse engineering framework.*
* **[Cutter](https://github.com/rizinorg/cutter) ⭐ 19,722 | 🐛 493 | 🌐 C++ | 📅 2026-09-11** - *Free and open-source reverse engineering platform.*
...
* **[Ghidra](https://github.com/NationalSecurityAgency/ghidra) ⭐ 75,082 | 🐛 1,954 | 🌐 Java | 📅 2026-09-11** - *Open-source software reverse engineering suite.*
* **[Capstone](https://github.com/capstone-engine/capstone) ⭐ 9,014 | 🐛 358 | 🌐 C | 📅 2026-09-10** - *Lightweight multi-architecture disassembly framework.*
* **[WABT](https://github.com/WebAssembly/wabt) ⭐ 8,127 | 🐛 242 | 🌐 C++ | 📅 2026-09-06** - *WebAssembly Binary Toolkit - disassembler and tools.*
...
* **[JADX](https://github.com/skylot/jadx) ⭐ 50,457 | 🐛 445 | 🌐 Java | 📅 2026-09-12** - *Dex to Java decompiler.*
* **[ILSpy](https://github.com/icsharpcode/ILSpy) ⭐ 26,060 | 🐛 176 | 🌐 C# | 📅 2026-09-13** - *Open-source .NET assembly browser.*
* **[Bytecode Viewer](https://github.com/Konloch/bytecode-viewer) ⭐ 15,642 | 🐛 103 | 🌐 Java | 📅 2026-07-17** - *Decompile Java/Android bytecode & more.*
* **[JD-GUI](https://github.com/java-decompiler/jd-gui) ⭐ 15,202 | 🐛 248 | 🌐 Java | 📅 2024-07-08** - *Decompile Java class files.*
* **[FFDec](https://github.com/jindrapetrik/jpexs-decompiler) ⭐ 5,867 | 🐛 2 | 🌐 Java | 📅 2026-09-13** - *Flash Decompiler.*
...
* **[ImHex](https://github.com/WerWolv/ImHex) ⭐ 54,793 | 🐛 396 | 🌐 C++ | 📅 2026-09-14** - *A fast and powerful hex editor.*
...
* **[Frida](https://github.com/frida/frida) ⭐ 21,918 | 🐛 1,962 | 🌐 Meson | 📅 2026-09-09** - *Dynamic instrumentation toolkit.*
* **[Cheat Engine](https://github.com/cheat-engine/cheat-engine) ⭐ 19,174 | 🐛 1,309 | 🌐 Pascal | 📅 2025-04-19** - *Memory scanner/debugger for games and applications.*
* **[ReClass.NET](https://github.com/ReClassNET/ReClass.NET) ⭐ 2,201 | 🐛 84 | 🌐 C# | 📅 2024-05-10** - *.Net structure class reverser.*
* **[XELFViewer](https://github.com/horsicq/XELFViewer) ⭐ 1,586 | 🐛 8 | 🌐 C++ | 📅 2026-09-13** - *ELF files viewer and editor.*
* **[Scylla](https://github.com/NtQuery/Scylla) ⭐ 1,429 | 🐛 23 | 🌐 C++ | 📅 2023-04-05** - *Powerful and advanced x86/x86-64 executable unpacker.*
* **[XPEViewer](https://github.com/horsicq/XPEViewer) ⭐ 1,234 | 🐛 5 | 🌐 QMake | 📅 2026-09-13** - *Executable file viewer and editor.*
...
* **[Xenos](https://github.com/DarthTon/Xenos) ⭐ 2,661 | 🐛 51 | 🌐 C++ | 📅 2021-05-17** - *DLL injector.*
...
* **[Exiftool](https://github.com/exiftool/exiftool) ⭐ 5,033 | 🐛 42 | 🌐 Perl | 📅 2026-05-27** - *Meta data editor.*
* **[Far Manager](https://github.com/FarGroup/FarManager) ⭐ 2,223 | 🐛 156 | 🌐 C++ | 📅 2026-09-12** - *Text-based file and archive manager for Windows.*
...
* **[XDELTA Patch Maker](https://github.com/jmacd/xdelta) ⭐ 1,347 | 🐛 107 | 🌐 C | 📅 2026-09-06** - *Patch creator for Inno Setup installers.*
...
* **[MilkyTracker](https://github.com/milkytracker/MilkyTracker) ⭐ 2,099 | 🐛 87 | 🌐 C++ | 📅 2026-09-10** - *Multi-platform music tracker inspired by FastTracker 2.*
...
* **[ScyllaHide](https://github.com/x64dbg/ScyllaHide) ⭐ 4,297 | 🐛 53 | 🌐 C++ | 📅 2024-06-04** - *Anti-(anti-debugger).*
...
* **[ProGuard](https://github.com/Guardsquare/proguard) ⭐ 3,656 | 🐛 176 | 🌐 Java | 📅 2026-08-24** - *Java optimizer and obfuscator.*
...
* **[UPX](https://github.com/upx/upx) ⭐ 17,871 | 🐛 21 | 🌐 C++ | 📅 2026-09-13** - *Free, portable, and extendable executable packer.*
...
* **[Etcher](https://github.com/balena-io/etcher) ⭐ 34,337 | 🐛 691 | 🌐 TypeScript | 📅 2026-06-02** - *A cross-platform tool to flash OS images onto SD cards and USB.*
* **[OTP Extractor](https://github.com/scito/extract_otp_secrets) ⭐ 1,655 | 🐛 3 | 🌐 Python | 📅 2026-09-12** - *Tool for extracting OTPs (One-Time Passwords).*
...
* **[Apktool](https://github.com/iBotPeaches/Apktool) ⭐ 25,553 | 🐛 77 | 🌐 Java | 📅 2026-09-04** - *Tool for decompiling and recompiling Android APK files.*
* **[APK Editor Studio](https://github.com/kefir500/apk-editor-studio) ⭐ 1,659 | 🐛 55 | 🌐 C++ | 📅 2025-01-19** - *Powerful APK editing tool.*
* **[Bifrost](https://github.com/zacharee/Bifrost) ⭐ 1,598 | 🐛 7 | 🌐 Kotlin | 📅 2026-09-05** - *Tool for downloading Samsung mobile device firmware.*
...
* **[uTinyRipper](https://github.com/mafaca/UtinyRipper) ⭐ 3,096 | 🐛 893 | 🌐 C# | 📅 2022-01-14** - *Unity asset extractor and exporter.*
...
* **[Logisim](https://github.com/logisim-evolution/logisim-evolution) ⭐ 7,562 | 🐛 107 | 🌐 Java | 📅 2026-09-12** - *Educational digital circuit simulator.*
* **[Arduino CLI](https://github.com/arduino/arduino-cli) ⭐ 5,023 | 🐛 268 | 🌐 Go | 📅 2026-09-13** - *Command-line interface for Arduino.*
* **[Fritzing](https://github.com/fritzing/fritzing-app) ⭐ 4,805 | 🐛 496 | 🌐 C++ | 📅 2026-08-12** - *An open-source electronics design software.*
...
* **[DevToys](https://github.com/DevToys-app/DevToys) ⭐ 31,993 | 🐛 341 | 🌐 C# | 📅 2026-02-25** - *A Swiss Army knife for developers.*
* **[Cmder](https://github.com/cmderdev/cmder) ⭐ 27,009 | 🐛 67 | 🌐 PowerShell | 📅 2026-08-31** - *Console emulator.*
* **[Dev-C++](https://github.com/Embarcadero/Dev-Cpp) ⭐ 3,004 | 🐛 214 | 🌐 Pascal | 📅 2024-06-17** - *A fast, portable, simple, and free C/C++ IDE.*
...
* **[Sandboxie](https://github.com/sandboxie-plus/Sandboxie) ⭐ 19,418 | 🐛 756 | 🌐 C | 📅 2026-09-13** - *Enhanced version of the popular sandboxing program.*
* **[Cmake](https://github.com/Kitware/CMake) ⭐ 8,074 | 🐛 2 | 🌐 C | 📅 2026-09-13** - *C, C++ builder.*
* **[Npcap](https://github.com/nmap/npcap) ⭐ 3,597 | 🐛 246 | 🌐 C | 📅 2026-09-12** - *Packet capture library installer.*
* **[MSYS2](https://github.com/nmap/npcap) ⭐ 3,597 | 🐛 246 | 🌐 C | 📅 2026-09-12** - *Unix SDK installer for Windows.*

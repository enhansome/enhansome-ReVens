...
* **[Yara](https://github.com/VirusTotal/yara) ⭐ 9,862 | 🐛 170 | 🌐 C | 📅 2026-08-25** - *Malware pattern matching tool.*
...
* **[Detect It Easy (DiE)](https://github.com/horsicq/DIE-engine) ⭐ 3,263 | 🐛 13 | 🌐 C++ | 📅 2026-09-11** - *File type identifier.*
...
* **[Driver Store Explorer](https://github.com/lostindark/DriverStoreExplorer) ⭐ 11,611 | 🐛 24 | 🌐 C# | 📅 2026-09-08** - *Driver Store Explorer.*
...
* **[Regshot](https://github.com/Seabreg/Regshot) ⭐ 547 | 🐛 3 | 📅 2019-06-15** - *Registry snapshot and comparison utility.*
...
* **[PE-sieve](https://github.com/hasherezade/pe-sieve) ⭐ 3,891 | 🐛 7 | 🌐 C++ | 📅 2026-06-06** - *Scans a given process.*
...
* **[HTTP Toolkit](https://github.com/httptoolkit/httptoolkit-desktop) ⭐ 728 | 🐛 18 | 🌐 TypeScript | 📅 2026-09-11** - *Intercept, view & edit any HTTP traffic.*
...
* **[XMachO Viewer](https://github.com/horsicq/XMachOViewer) ⭐ 963 | 🐛 4 | 🌐 C++ | 📅 2026-09-11** - *Mac OS XMachO Viewer.*
...
* **[.NET Reactor Slayer](https://github.com/SychicBoy/NETReactorSlayer) ⭐ 1,261 | 🐛 32 | 🌐 C# | 📅 2024-07-12** - *Deobfuscator and unpacker for .NET Reactor.*
...
* **[CyberChef](https://github.com/gchq/CyberChef) ⭐ 35,808 | 🐛 581 | 🌐 JavaScript | 📅 2026-09-11** - *Analyzing and decoding data.*
...
* **[UEFITool](https://github.com/LongSoft/UEFITool) ⭐ 5,666 | 🐛 23 | 🌐 C | 📅 2026-07-29** - *UEFI firmware image viewer and editor.*
...
* **[x64dbg](https://github.com/x64dbg/x64dbg) ⭐ 49,484 | 🐛 580 | 🌐 C++ | 📅 2026-09-10** - *Graphical debugger for x86 and x86-64 executables.*
* **[dnSpy](https://github.com/dnSpy/dnSpy) ⚠️ Archived** - *.NET assembly editor, decompiler, and debugger.*
* **[Radare2](https://github.com/radareorg/radare2) ⭐ 24,778 | 🐛 824 | 🌐 C | 📅 2026-09-11** - *A portable and multi-architecture reverse engineering framework.*
...
* **[Ghidra](https://github.com/NationalSecurityAgency/ghidra) ⭐ 74,831 | 🐛 1,941 | 🌐 Java | 📅 2026-09-11** - *Open-source software reverse engineering suite.*
* **[Capstone](https://github.com/capstone-engine/capstone) ⭐ 9,010 | 🐛 357 | 🌐 C | 📅 2026-09-10** - *Lightweight multi-architecture disassembly framework.*
...
* **[JADX](https://github.com/skylot/jadx) ⭐ 50,428 | 🐛 447 | 🌐 Java | 📅 2026-09-08** - *Dex to Java decompiler.*
* **[ILSpy](https://github.com/icsharpcode/ILSpy) ⭐ 26,057 | 🐛 171 | 🌐 C# | 📅 2026-09-10** - *Open-source .NET assembly browser.*
...
* **[FFDec](https://github.com/jindrapetrik/jpexs-decompiler) ⭐ 5,862 | 🐛 2 | 🌐 Java | 📅 2026-09-11** - *Flash Decompiler.*
...
* **[ImHex](https://github.com/WerWolv/ImHex) ⭐ 54,778 | 🐛 398 | 🌐 C++ | 📅 2026-09-11** - *A fast and powerful hex editor.*
...
* **[Frida](https://github.com/frida/frida) ⭐ 21,892 | 🐛 1,962 | 🌐 Meson | 📅 2026-09-09** - *Dynamic instrumentation toolkit.*
* **[Cheat Engine](https://github.com/cheat-engine/cheat-engine) ⭐ 19,165 | 🐛 1,308 | 🌐 Pascal | 📅 2025-04-19** - *Memory scanner/debugger for games and applications.*
* **[ReClass.NET](https://github.com/ReClassNET/ReClass.NET) ⭐ 2,199 | 🐛 84 | 🌐 C# | 📅 2024-05-10** - *.Net structure class reverser.*
* **[XELFViewer](https://github.com/horsicq/XELFViewer) ⭐ 1,585 | 🐛 8 | 🌐 C++ | 📅 2026-09-11** - *ELF files viewer and editor.*
* **[Scylla](https://github.com/NtQuery/Scylla) ⭐ 1,427 | 🐛 23 | 🌐 C++ | 📅 2023-04-05** - *Powerful and advanced x86/x86-64 executable unpacker.*
* **[XPEViewer](https://github.com/horsicq/XPEViewer) ⭐ 1,233 | 🐛 5 | 🌐 QMake | 📅 2026-09-11** - *Executable file viewer and editor.*
...
* **[Exiftool](https://github.com/exiftool/exiftool) ⭐ 5,028 | 🐛 42 | 🌐 Perl | 📅 2026-05-27** - *Meta data editor.*
...
* **[WinSCP](https://github.com/winscp/winscp) ⭐ 3,831 | 🐛 1 | 🌐 C | 📅 2026-09-11** - *Free SFTP, SCP, and FTP client for Windows.*
...
* **[OpenMPT](https://github.com/OpenMPT/openmpt) ⭐ 772 | 🐛 3 | 🌐 C++ | 📅 2026-08-29** - *Open-source tracker software.*
...
* **[Nasm](https://github.com/netwide-assembler/nasm) ⭐ 3,311 | 🐛 71 | 🌐 Assembly | 📅 2026-08-19** - *Netwide Assembler for x86 architecture.*
...
* **[ProGuard](https://github.com/Guardsquare/proguard) ⭐ 3,655 | 🐛 176 | 🌐 Java | 📅 2026-08-24** - *Java optimizer and obfuscator.*
...
* **[UPX](https://github.com/upx/upx) ⭐ 17,862 | 🐛 23 | 🌐 C++ | 📅 2026-09-11** - *Free, portable, and extendable executable packer.*
...
* **[Etcher](https://github.com/balena-io/etcher) ⭐ 34,324 | 🐛 690 | 🌐 TypeScript | 📅 2026-06-02** - *A cross-platform tool to flash OS images onto SD cards and USB.*
* **[OTP Extractor](https://github.com/scito/extract_otp_secrets) ⭐ 1,655 | 🐛 8 | 🌐 Python | 📅 2026-09-11** - *Tool for extracting OTPs (One-Time Passwords).*
...
* **[Apktool](https://github.com/iBotPeaches/Apktool) ⭐ 25,534 | 🐛 77 | 🌐 Java | 📅 2026-09-04** - *Tool for decompiling and recompiling Android APK files.*
* **[APK Editor Studio](https://github.com/kefir500/apk-editor-studio) ⭐ 1,655 | 🐛 55 | 🌐 C++ | 📅 2025-01-19** - *Powerful APK editing tool.*
* **[Bifrost](https://github.com/zacharee/Bifrost) ⭐ 1,599 | 🐛 5 | 🌐 Kotlin | 📅 2026-09-05** - *Tool for downloading Samsung mobile device firmware.*
...
* **[Logisim](https://github.com/logisim-evolution/logisim-evolution) ⭐ 7,555 | 🐛 105 | 🌐 Java | 📅 2026-09-11** - *Educational digital circuit simulator.*
* **[Arduino CLI](https://github.com/arduino/arduino-cli) ⭐ 5,021 | 🐛 267 | 🌐 Go | 📅 2026-09-11** - *Command-line interface for Arduino.*
* **[Fritzing](https://github.com/fritzing/fritzing-app) ⭐ 4,804 | 🐛 496 | 🌐 C++ | 📅 2026-08-12** - *An open-source electronics design software.*
...
* **[DevToys](https://github.com/DevToys-app/DevToys) ⭐ 31,983 | 🐛 341 | 🌐 C# | 📅 2026-02-25** - *A Swiss Army knife for developers.*
* **[Cmder](https://github.com/cmderdev/cmder) ⭐ 27,008 | 🐛 67 | 🌐 PowerShell | 📅 2026-08-31** - *Console emulator.*
...
* **[Sandboxie](https://github.com/sandboxie-plus/Sandboxie) ⭐ 19,399 | 🐛 750 | 🌐 C | 📅 2026-09-06** - *Enhanced version of the popular sandboxing program.*
* **[Cmake](https://github.com/Kitware/CMake) ⭐ 8,070 | 🐛 2 | 🌐 C | 📅 2026-09-11** - *C, C++ builder.*
* **[Npcap](https://github.com/nmap/npcap) ⭐ 3,595 | 🐛 246 | 🌐 C | 📅 2026-09-11** - *Packet capture library installer.*
* **[MSYS2](https://github.com/nmap/npcap) ⭐ 3,595 | 🐛 246 | 🌐 C | 📅 2026-09-11** - *Unix SDK installer for Windows.*

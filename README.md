...
* Download latest ReVens from: [Releases](https://github.com/Jakiboy/ReVens/releases) ⭐ 358 | 🐛 0 | 🌐 JavaScript | 📅 2026-05-23.
...
* **[Yara](https://github.com/VirusTotal/yara) ⭐ 9,870 | 🐛 170 | 🌐 C | 📅 2026-08-25** - *Malware pattern matching tool.*
* **[Capa](https://github.com/mandiant/capa) ⭐ 6,183 | 🐛 301 | 🌐 Python | 📅 2026-09-14** - *Identify capabilities in executables.*
* **[PE-bear](https://github.com/hasherezade/pe-bear) ⭐ 3,803 | 🐛 16 | 🌐 C++ | 📅 2026-09-11** - *PE reversing tool.*
...
* **[Detect It Easy (DiE)](https://github.com/horsicq/DIE-engine) ⭐ 3,265 | 🐛 13 | 🌐 C++ | 📅 2026-09-11** - *File type identifier.*
* **[Nauz File Detector](https://github.com/horsicq/Nauz-File-Detector) ⭐ 581 | 🐛 2 | 🌐 C++ | 📅 2026-09-14** - *Detects compiler tools.*
...
* **[Exeinfo PE (ASL)](https://github.com/ExeinfoASL/ASL) ⭐ 1,149 | 🐛 8 | 📅 2026-09-11** - *Detects packers and compressors.*
...
* **[Driver Store Explorer](https://github.com/lostindark/DriverStoreExplorer) ⭐ 11,638 | 🐛 25 | 🌐 C# | 📅 2026-09-08** - *Driver Store Explorer.*
...
* **[Regshot](https://github.com/Seabreg/Regshot) ⭐ 548 | 🐛 3 | 📅 2019-06-15** - *Registry snapshot and comparison utility.*
...
* **[PE-sieve](https://github.com/hasherezade/pe-sieve) ⭐ 3,892 | 🐛 7 | 🌐 C++ | 📅 2026-06-06** - *Scans a given process.*
* **[Hollows Hunter](https://github.com/hasherezade/hollows_hunter) ⭐ 2,404 | 🐛 2 | 🌐 C | 📅 2026-06-06** - *Scans running processes for code injection artifacts.*
...
* **[PacketSender](https://github.com/dannagle/PacketSender) ⭐ 2,678 | 🐛 67 | 🌐 C++ | 📅 2026-09-13** - *Send & receive TCP, UDP, SSL, DTLS. HTTP Requests.*
* **[HTTP Toolkit](https://github.com/httptoolkit/httptoolkit-desktop) ⭐ 730 | 🐛 18 | 🌐 TypeScript | 📅 2026-09-14** - *Intercept, view & edit any HTTP traffic.*
...
* **[SQLiteStudio](https://github.com/pawelsalawa/sqlitestudio) ⭐ 6,739 | 🐛 490 | 🌐 C | 📅 2026-08-24** - *SQLite database manager.*
* **[GrepWin (Text)](https://github.com/stefankueng/grepWin) ⭐ 2,069 | 🐛 48 | 🌐 C++ | 📅 2026-09-05** - *Search tool for Windows.*
* **[XMachO Viewer](https://github.com/horsicq/XMachOViewer) ⭐ 964 | 🐛 4 | 🌐 C++ | 📅 2026-09-14** - *Mac OS XMachO Viewer.*
...
* **[RHash](https://github.com/rhash/RHash) ⭐ 730 | 🐛 43 | 🌐 C | 📅 2026-04-11** - *Utility for computing hash sums.*
* **[XOpcodeCalc](https://github.com/horsicq/XOpcodeCalc) ⭐ 412 | 🐛 6 | 🌐 C++ | 📅 2026-09-14** - *Opcode calculator tool.*
...
* **[.NET Reactor Slayer](https://github.com/SychicBoy/NETReactorSlayer) ⭐ 1,262 | 🐛 32 | 🌐 C# | 📅 2026-09-12** - *Deobfuscator and unpacker for .NET Reactor.*
* **[MalUnpack](https://github.com/hasherezade/mal_unpack) ⭐ 840 | 🐛 1 | 🌐 C | 📅 2026-04-14** - *Dynamic unpacker for malware analysis.*
* **[GUnPacker](https://github.com/unipacker/unipacker) ⭐ 775 | 🐛 28 | 🌐 Python | 📅 2025-08-18** - *Generic unpacker.*
* **[Magicmida](https://github.com/Hendi48/Magicmida) ⭐ 707 | 🐛 17 | 🌐 Pascal | 📅 2026-05-14** - *Themida/WinLicense unpacker.*
...
* **[CyberChef](https://github.com/gchq/CyberChef) ⭐ 35,840 | 🐛 594 | 🌐 JavaScript | 📅 2026-09-11** - *Analyzing and decoding data.*
* **[RSA-Tool 2](https://github.com/ius/rsatool) ⭐ 1,662 | 🐛 2 | 🌐 Python | 📅 2026-07-20** - *Tool for generating and analyzing RSA keys.*
* **[RSATool](https://github.com/ius/rsatool) ⭐ 1,662 | 🐛 2 | 🌐 Python | 📅 2026-07-20** - *Generate, convert and analyze RSA keys.*
...
* **[UEFITool](https://github.com/LongSoft/UEFITool) ⭐ 5,673 | 🐛 23 | 🌐 C | 📅 2026-07-29** - *UEFI firmware image viewer and editor.*
* **[UniExtract](https://github.com/Bioruebe/UniExtract2) ⭐ 4,419 | 🐛 123 | 🌐 AutoIt | 📅 2024-07-06** - *Universal archive extractor.*
* **[PDBRipper](https://github.com/horsicq/PDBRipper/) ⭐ 904 | 🐛 18 | 🌐 C++ | 📅 2026-09-14** - *PDB file ripper and information extractor.*
* **[Ratr](https://github.com/Jakiboy/Ratr) ⭐ 25 | 🐛 0 | 🌐 C# | 📅 2026-08-05** - *Router Config Extractor.*
...
* **[LessMSI](https://github.com/activescott/lessmsi) ⭐ 1,763 | 🐛 55 | 🌐 C# | 📅 2026-04-02** - *Command-line tool to extract data from MSI files.*
...
* **[x64dbg](https://github.com/x64dbg/x64dbg) ⭐ 49,508 | 🐛 578 | 🌐 C++ | 📅 2026-09-14** - *Graphical debugger for x86 and x86-64 executables.*
* **[dnSpy](https://github.com/dnSpy/dnSpy) ⚠️ Archived** - *.NET assembly editor, decompiler, and debugger.*
* **[Radare2](https://github.com/radareorg/radare2) ⭐ 24,796 | 🐛 824 | 🌐 C | 📅 2026-09-14** - *A portable and multi-architecture reverse engineering framework.*
* **[Cutter](https://github.com/rizinorg/cutter) ⭐ 19,727 | 🐛 493 | 🌐 C++ | 📅 2026-09-11** - *Free and open-source reverse engineering platform.*
...
* **[Ghidra](https://github.com/NationalSecurityAgency/ghidra) ⭐ 75,905 | 🐛 1,962 | 🌐 Java | 📅 2026-09-14** - *Open-source software reverse engineering suite.*
* **[Capstone](https://github.com/capstone-engine/capstone) ⭐ 9,021 | 🐛 358 | 🌐 C | 📅 2026-09-10** - *Lightweight multi-architecture disassembly framework.*
* **[WABT](https://github.com/WebAssembly/wabt) ⭐ 8,129 | 🐛 237 | 🌐 C++ | 📅 2026-09-14** - *WebAssembly Binary Toolkit - disassembler and tools.*
...
* **[JADX](https://github.com/skylot/jadx) ⭐ 50,464 | 🐛 446 | 🌐 Java | 📅 2026-09-12** - *Dex to Java decompiler.*
* **[ILSpy](https://github.com/icsharpcode/ILSpy) ⭐ 26,067 | 🐛 178 | 🌐 C# | 📅 2026-09-14** - *Open-source .NET assembly browser.*
* **[Bytecode Viewer](https://github.com/Konloch/bytecode-viewer) ⭐ 15,645 | 🐛 103 | 🌐 Java | 📅 2026-07-17** - *Decompile Java/Android bytecode & more.*
* **[JD-GUI](https://github.com/java-decompiler/jd-gui) ⭐ 15,202 | 🐛 248 | 🌐 Java | 📅 2024-07-08** - *Decompile Java class files.*
* **[FFDec](https://github.com/jindrapetrik/jpexs-decompiler) ⭐ 5,871 | 🐛 3 | 🌐 Java | 📅 2026-09-14** - *Flash Decompiler.*
...
* **[ImHex](https://github.com/WerWolv/ImHex) ⭐ 54,803 | 🐛 397 | 🌐 C++ | 📅 2026-09-14** - *A fast and powerful hex editor.*
...
* **[Frida](https://github.com/frida/frida) ⭐ 21,933 | 🐛 1,962 | 🌐 Meson | 📅 2026-09-09** - *Dynamic instrumentation toolkit.*
* **[Cheat Engine](https://github.com/cheat-engine/cheat-engine) ⭐ 19,176 | 🐛 1,309 | 🌐 Pascal | 📅 2025-04-19** - *Memory scanner/debugger for games and applications.*
* **[ReClass.NET](https://github.com/ReClassNET/ReClass.NET) ⭐ 2,203 | 🐛 84 | 🌐 C# | 📅 2024-05-10** - *.Net structure class reverser.*
* **[XELFViewer](https://github.com/horsicq/XELFViewer) ⭐ 1,586 | 🐛 8 | 🌐 C++ | 📅 2026-09-14** - *ELF files viewer and editor.*
* **[Scylla](https://github.com/NtQuery/Scylla) ⭐ 1,429 | 🐛 23 | 🌐 C++ | 📅 2023-04-05** - *Powerful and advanced x86/x86-64 executable unpacker.*
* **[XPEViewer](https://github.com/horsicq/XPEViewer) ⭐ 1,235 | 🐛 5 | 🌐 QMake | 📅 2026-09-14** - *Executable file viewer and editor.*
* **[PE Tools](https://github.com/petoolse/petools) ⭐ 1,199 | 🐛 10 | 📅 2025-10-21** - *PE manipulation toolkit.*
* **[KDiff3](https://github.com/KDE/kdiff3) ⭐ 618 | 🐛 0 | 🌐 C++ | 📅 2026-09-14** - *File and directory diff and merge tool.*
...
* **[Xenos](https://github.com/DarthTon/Xenos) ⭐ 2,660 | 🐛 51 | 🌐 C++ | 📅 2021-05-17** - *DLL injector.*
...
* **[Exiftool](https://github.com/exiftool/exiftool) ⭐ 5,037 | 🐛 42 | 🌐 Perl | 📅 2026-05-27** - *Meta data editor.*
* **[Far Manager](https://github.com/FarGroup/FarManager) ⭐ 2,223 | 🐛 156 | 🌐 C++ | 📅 2026-09-14** - *Text-based file and archive manager for Windows.*
...
* **[WinSCP](https://github.com/winscp/winscp) ⭐ 3,831 | 🐛 1 | 🌐 C | 📅 2026-09-12** - *Free SFTP, SCP, and FTP client for Windows.*
...
* **[XDELTA Patch Maker](https://github.com/jmacd/xdelta) ⭐ 1,348 | 🐛 107 | 🌐 C | 📅 2026-09-06** - *Patch creator for Inno Setup installers.*
...
* **[MilkyTracker](https://github.com/milkytracker/MilkyTracker) ⭐ 2,100 | 🐛 87 | 🌐 C++ | 📅 2026-09-10** - *Multi-platform music tracker inspired by FastTracker 2.*
* **[OpenMPT](https://github.com/OpenMPT/openmpt) ⭐ 774 | 🐛 3 | 🌐 C++ | 📅 2026-08-29** - *Open-source tracker software.*
...
* **[Nasm](https://github.com/netwide-assembler/nasm) ⭐ 3,313 | 🐛 72 | 🌐 Assembly | 📅 2026-08-19** - *Netwide Assembler for x86 architecture.*
...
* **[ScyllaHide](https://github.com/x64dbg/ScyllaHide) ⭐ 4,300 | 🐛 53 | 🌐 C++ | 📅 2024-06-04** - *Anti-(anti-debugger).*
...
* **[ProGuard](https://github.com/Guardsquare/proguard) ⭐ 3,660 | 🐛 176 | 🌐 Java | 📅 2026-08-24** - *Java optimizer and obfuscator.*
...
* **[UPX](https://github.com/upx/upx) ⭐ 17,869 | 🐛 20 | 🌐 C++ | 📅 2026-09-14** - *Free, portable, and extendable executable packer.*
...
* **[Etcher](https://github.com/balena-io/etcher) ⭐ 34,342 | 🐛 691 | 🌐 TypeScript | 📅 2026-06-02** - *A cross-platform tool to flash OS images onto SD cards and USB.*
* **[OTP Extractor](https://github.com/scito/extract_otp_secrets) ⭐ 1,656 | 🐛 3 | 🌐 Python | 📅 2026-09-12** - *Tool for extracting OTPs (One-Time Passwords).*
...
* **[Apktool](https://github.com/iBotPeaches/Apktool) ⭐ 25,562 | 🐛 77 | 🌐 Java | 📅 2026-09-04** - *Tool for decompiling and recompiling Android APK files.*
* **[APK Editor Studio](https://github.com/kefir500/apk-editor-studio) ⭐ 1,659 | 🐛 55 | 🌐 C++ | 📅 2025-01-19** - *Powerful APK editing tool.*
* **[Bifrost](https://github.com/zacharee/Bifrost) ⭐ 1,597 | 🐛 7 | 🌐 Kotlin | 📅 2026-09-05** - *Tool for downloading Samsung mobile device firmware.*
* **[Frija](https://github.com/SlackingVeteran/frija) ⭐ 746 | 🐛 0 | 📅 2026-05-22** - *Tool for downloading Samsung firmware.*
* **[XAPK Detector](https://github.com/horsicq/XAPKDetector) ⭐ 693 | 🐛 1 | 🌐 C++ | 📅 2026-09-14** - *Detects and handles XAPK files.*
...
* **[uTinyRipper](https://github.com/mafaca/UtinyRipper) ⭐ 3,097 | 🐛 893 | 🌐 C# | 📅 2022-01-14** - *Unity asset extractor and exporter.*
* **[Dragon UnPACKer](https://github.com/elbereth/DragonUnPACKer) ⭐ 257 | 🐛 120 | 🌐 Pascal | 📅 2024-06-05** - *Tool for opening and extracting game resource files.*
...
* **[Quark](https://github.com/XorTroll/Goldleaf) ⭐ 3,038 | 🐛 89 | 🌐 C | 📅 2026-09-06** - *Nintendo Switch games installer using Goldleaf.*
* **[DBI Backend](https://github.com/rashevskyv/dbi) ⭐ 2,936 | 🐛 73 | 🌐 Python | 📅 2026-07-17** - *Nintendo Switch games installer (NSP, NSZ, XCI, XCZ) using DBI (MTP, USB, HTTP).*
* **[NS-USBloader](https://github.com/developersu/ns-usbloader) ⭐ 2,329 | 🐛 50 | 🌐 Java | 📅 2026-08-27** - *Nintendo Switch games installer using Awoo-Installer.*
* **[TegraRcmGUI](https://github.com/eliboa/TegraRcmGUI) ⭐ 2,301 | 🐛 24 | 🌐 C++ | 📅 2021-11-30** - *Nintendo Switch payload injector (RCM Mode).*
* **[SysDVR](https://github.com/exelix11/SysDVR) ⭐ 2,021 | 🐛 12 | 🌐 C++ | 📅 2026-07-16** - *Nintendo Switch streaming client.*
* **[Switch LAN Play](https://github.com/spacemeowx2/switch-lan-play) ⭐ 2,015 | 🐛 62 | 🌐 C | 📅 2025-03-21** - *Nintendo Switch LAN client.*
* **[Appstore](https://github.com/fortheusers/hb-appstore) ⭐ 1,459 | 🐛 27 | 🌐 C++ | 📅 2026-07-08** - *GUI Homebrew app store for CFW.*
* **[NXDT Host](https://github.com/DarkMatterCore/nxdumptool) ⭐ 1,294 | 🐛 20 | 🌐 C | 📅 2026-08-04** - *Nintendo Switch dump tool server.*
* **[NUT](https://github.com/blawar/nut) ⭐ 1,270 | 🐛 77 | 🌐 Python | 📅 2026-01-19** - *Nintendo Switch games installer using Tinfoil.*
* **[Switch Theme Injector](https://github.com/exelix11/SwitchThemeInjector) ⭐ 1,237 | 🐛 26 | 🌐 C | 📅 2026-09-11** - *Custom themes creator for Nintendo Switch.*
* **[Joy-Con Toolkit](https://github.com/CTCaer/jc_toolkit) ⭐ 1,104 | 🐛 77 | 🌐 C++ | 📅 2024-05-07** - *Nintendo Switch Joy-Con toolkit.*
* **[NX Nand Manager](https://github.com/eliboa/NxNandManager) ⭐ 973 | 🐛 50 | 🌐 C++ | 📅 2026-09-11** - *Nintendo Switch NAND manager.*
...
* **[Nand Fix Pro](https://github.com/sthetix/NANDFixPro) ⭐ 122 | 🐛 2 | 🌐 Python | 📅 2026-06-23** - *Nintendo Switch NAND repair tool.*
...
* **[Logisim](https://github.com/logisim-evolution/logisim-evolution) ⭐ 7,569 | 🐛 108 | 🌐 Java | 📅 2026-09-14** - *Educational digital circuit simulator.*
* **[Arduino CLI](https://github.com/arduino/arduino-cli) ⭐ 5,023 | 🐛 270 | 🌐 Go | 📅 2026-09-14** - *Command-line interface for Arduino.*
* **[Fritzing](https://github.com/fritzing/fritzing-app) ⭐ 4,806 | 🐛 496 | 🌐 C++ | 📅 2026-08-12** - *An open-source electronics design software.*
* **[PICSimLab](https://github.com/lcgamboa/picsimlab) ⭐ 665 | 🐛 9 | 🌐 C++ | 📅 2026-09-13** - *PIC microcontroller simulator.*
* **[SimulIDE](https://github.com/simulide/simulide) ⭐ 309 | 🐛 23 | 🌐 C++ | 📅 2021-11-04** - *Real-time electronics simulator.*
...
* **[DevToys](https://github.com/DevToys-app/DevToys) ⭐ 31,999 | 🐛 341 | 🌐 C# | 📅 2026-02-25** - *A Swiss Army knife for developers.*
* **[Cmder](https://github.com/cmderdev/cmder) ⭐ 27,009 | 🐛 67 | 🌐 PowerShell | 📅 2026-09-14** - *Console emulator.*
* **[Dev-C++](https://github.com/Embarcadero/Dev-Cpp) ⭐ 3,006 | 🐛 214 | 🌐 Pascal | 📅 2024-06-17** - *A fast, portable, simple, and free C/C++ IDE.*
...
* **[Sandboxie](https://github.com/sandboxie-plus/Sandboxie) ⭐ 19,423 | 🐛 756 | 🌐 C | 📅 2026-09-13** - *Enhanced version of the popular sandboxing program.*
* **[Cmake](https://github.com/Kitware/CMake) ⭐ 8,076 | 🐛 2 | 🌐 C | 📅 2026-09-14** - *C, C++ builder.*
* **[Npcap](https://github.com/nmap/npcap) ⭐ 3,599 | 🐛 246 | 🌐 C | 📅 2026-09-12** - *Packet capture library installer.*
* **[MSYS2](https://github.com/nmap/npcap) ⭐ 3,599 | 🐛 246 | 🌐 C | 📅 2026-09-12** - *Unix SDK installer for Windows.*

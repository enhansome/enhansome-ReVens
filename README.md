...
* **[Yara](https://github.com/VirusTotal/yara) ⭐ 9,894 | 🐛 167 | 🌐 C | 📅 2026-09-23** - *Malware pattern matching tool.*
* **[Capa](https://github.com/mandiant/capa) ⭐ 6,199 | 🐛 308 | 🌐 Python | 📅 2026-09-14** - *Identify capabilities in executables.*
* **[PE-bear](https://github.com/hasherezade/pe-bear) ⭐ 3,820 | 🐛 16 | 🌐 C++ | 📅 2026-09-20** - *PE reversing tool.*
...
* **[Detect It Easy (DiE)](https://github.com/horsicq/DIE-engine) ⭐ 3,272 | 🐛 14 | 🌐 C++ | 📅 2026-09-25** - *File type identifier.*
...
* **[Driver Store Explorer](https://github.com/lostindark/DriverStoreExplorer) ⭐ 11,730 | 🐛 25 | 🌐 C# | 📅 2026-09-16** - *Driver Store Explorer.*
...
* **[Hollows Hunter](https://github.com/hasherezade/hollows_hunter) ⭐ 2,412 | 🐛 2 | 🌐 C | 📅 2026-06-06** - *Scans running processes for code injection artifacts.*
...
* **[SQLiteStudio](https://github.com/pawelsalawa/sqlitestudio) ⭐ 6,758 | 🐛 493 | 🌐 C | 📅 2026-09-18** - *SQLite database manager.*
* **[GrepWin (Text)](https://github.com/stefankueng/grepWin) ⭐ 2,077 | 🐛 46 | 🌐 C++ | 📅 2026-09-26** - *Search tool for Windows.*
* **[XMachO Viewer](https://github.com/horsicq/XMachOViewer) ⭐ 963 | 🐛 4 | 🌐 C++ | 📅 2026-09-25** - *Mac OS XMachO Viewer.*
...
* **[RHash](https://github.com/rhash/RHash) ⭐ 731 | 🐛 44 | 🌐 C | 📅 2026-04-11** - *Utility for computing hash sums.*
...
* **[Magicmida](https://github.com/Hendi48/Magicmida) ⭐ 713 | 🐛 17 | 🌐 Pascal | 📅 2026-05-14** - *Themida/WinLicense unpacker.*
...
* **[CyberChef](https://github.com/gchq/CyberChef) ⭐ 35,957 | 🐛 584 | 🌐 JavaScript | 📅 2026-09-25** - *Analyzing and decoding data.*
...
* **[UEFITool](https://github.com/LongSoft/UEFITool) ⭐ 5,695 | 🐛 24 | 🌐 C | 📅 2026-07-29** - *UEFI firmware image viewer and editor.*
* **[UniExtract](https://github.com/Bioruebe/UniExtract2) ⭐ 4,434 | 🐛 123 | 🌐 AutoIt | 📅 2024-07-06** - *Universal archive extractor.*
* **[PDBRipper](https://github.com/horsicq/PDBRipper/) ⭐ 905 | 🐛 18 | 🌐 C++ | 📅 2026-09-22** - *PDB file ripper and information extractor.*
...
* **[x64dbg](https://github.com/x64dbg/x64dbg) ⭐ 49,603 | 🐛 572 | 🌐 C++ | 📅 2026-09-26** - *Graphical debugger for x86 and x86-64 executables.*
* **[dnSpy](https://github.com/dnSpy/dnSpy) ⚠️ Archived** - *.NET assembly editor, decompiler, and debugger.*
* **[Radare2](https://github.com/radareorg/radare2) ⭐ 24,871 | 🐛 818 | 🌐 C | 📅 2026-09-25** - *A portable and multi-architecture reverse engineering framework.*
* **[Cutter](https://github.com/rizinorg/cutter) ⭐ 19,819 | 🐛 495 | 🌐 C++ | 📅 2026-09-11** - *Free and open-source reverse engineering platform.*
...
* **[Ghidra](https://github.com/NationalSecurityAgency/ghidra) ⭐ 79,675 | 🐛 1,959 | 🌐 Java | 📅 2026-09-25** - *Open-source software reverse engineering suite.*
* **[Capstone](https://github.com/capstone-engine/capstone) ⭐ 9,042 | 🐛 353 | 🌐 C | 📅 2026-09-24** - *Lightweight multi-architecture disassembly framework.*
...
* **[JADX](https://github.com/skylot/jadx) ⭐ 50,628 | 🐛 452 | 🌐 Java | 📅 2026-09-25** - *Dex to Java decompiler.*
* **[ILSpy](https://github.com/icsharpcode/ILSpy) ⭐ 26,140 | 🐛 180 | 🌐 C# | 📅 2026-09-25** - *Open-source .NET assembly browser.*
* **[Bytecode Viewer](https://github.com/Konloch/bytecode-viewer) ⭐ 15,654 | 🐛 103 | 🌐 Java | 📅 2026-07-17** - *Decompile Java/Android bytecode & more.*
* **[JD-GUI](https://github.com/java-decompiler/jd-gui) ⭐ 15,197 | 🐛 248 | 🌐 Java | 📅 2024-07-08** - *Decompile Java class files.*
* **[FFDec](https://github.com/jindrapetrik/jpexs-decompiler) ⭐ 5,887 | 🐛 2 | 🌐 Java | 📅 2026-09-24** - *Flash Decompiler.*
...
* **[ImHex](https://github.com/WerWolv/ImHex) ⭐ 54,909 | 🐛 399 | 🌐 C++ | 📅 2026-09-23** - *A fast and powerful hex editor.*
...
* **[Frida](https://github.com/frida/frida) ⭐ 22,039 | 🐛 1,965 | 🌐 Meson | 📅 2026-09-25** - *Dynamic instrumentation toolkit.*
* **[Cheat Engine](https://github.com/cheat-engine/cheat-engine) ⭐ 19,225 | 🐛 1,311 | 🌐 Pascal | 📅 2025-04-19** - *Memory scanner/debugger for games and applications.*
* **[ReClass.NET](https://github.com/ReClassNET/ReClass.NET) ⭐ 2,212 | 🐛 84 | 🌐 C# | 📅 2024-05-10** - *.Net structure class reverser.*
* **[XELFViewer](https://github.com/horsicq/XELFViewer) ⭐ 1,584 | 🐛 8 | 🌐 C++ | 📅 2026-09-25** - *ELF files viewer and editor.*
* **[Scylla](https://github.com/NtQuery/Scylla) ⭐ 1,436 | 🐛 23 | 🌐 C++ | 📅 2023-04-05** - *Powerful and advanced x86/x86-64 executable unpacker.*
* **[XPEViewer](https://github.com/horsicq/XPEViewer) ⭐ 1,235 | 🐛 5 | 🌐 QMake | 📅 2026-09-25** - *Executable file viewer and editor.*
...
* **[Exiftool](https://github.com/exiftool/exiftool) ⭐ 5,090 | 🐛 45 | 🌐 Perl | 📅 2026-05-27** - *Meta data editor.*
* **[Far Manager](https://github.com/FarGroup/FarManager) ⭐ 2,230 | 🐛 156 | 🌐 C++ | 📅 2026-09-25** - *Text-based file and archive manager for Windows.*
...
* **[WinSCP](https://github.com/winscp/winscp) ⭐ 3,856 | 🐛 1 | 🌐 C | 📅 2026-09-25** - *Free SFTP, SCP, and FTP client for Windows.*
...
* **[XDELTA Patch Maker](https://github.com/jmacd/xdelta) ⭐ 1,357 | 🐛 101 | 🌐 C | 📅 2026-09-25** - *Patch creator for Inno Setup installers.*
...
* **[ProTracker](https://github.com/8bitbubsy/pt2-clone) ⭐ 666 | 🐛 6 | 🌐 C | 📅 2026-09-17** - *Classic Amiga music tracker software.*
...
* **[Nasm](https://github.com/netwide-assembler/nasm) ⭐ 3,316 | 🐛 85 | 🌐 Assembly | 📅 2026-08-19** - *Netwide Assembler for x86 architecture.*
...
* **[ScyllaHide](https://github.com/x64dbg/ScyllaHide) ⭐ 4,311 | 🐛 53 | 🌐 C++ | 📅 2024-06-04** - *Anti-(anti-debugger).*
...
* **[ProGuard](https://github.com/Guardsquare/proguard) ⭐ 3,665 | 🐛 177 | 🌐 Java | 📅 2026-08-24** - *Java optimizer and obfuscator.*
...
* **[UPX](https://github.com/upx/upx) ⭐ 17,900 | 🐛 21 | 🌐 C++ | 📅 2026-09-25** - *Free, portable, and extendable executable packer.*
...
* **[Etcher](https://github.com/balena-io/etcher) ⭐ 34,420 | 🐛 695 | 🌐 TypeScript | 📅 2026-09-18** - *A cross-platform tool to flash OS images onto SD cards and USB.*
...
* **[Apktool](https://github.com/iBotPeaches/Apktool) ⭐ 25,668 | 🐛 77 | 🌐 Java | 📅 2026-09-21** - *Tool for decompiling and recompiling Android APK files.*
* **[APK Editor Studio](https://github.com/kefir500/apk-editor-studio) ⭐ 1,666 | 🐛 55 | 🌐 C++ | 📅 2025-01-19** - *Powerful APK editing tool.*
* **[Bifrost](https://github.com/zacharee/Bifrost) ⭐ 1,607 | 🐛 10 | 🌐 Kotlin | 📅 2026-09-05** - *Tool for downloading Samsung mobile device firmware.*
* **[Frija](https://github.com/SlackingVeteran/frija) ⭐ 748 | 🐛 0 | 📅 2026-05-22** - *Tool for downloading Samsung firmware.*
* **[XAPK Detector](https://github.com/horsicq/XAPKDetector) ⭐ 693 | 🐛 1 | 🌐 C++ | 📅 2026-09-25** - *Detects and handles XAPK files.*
...
* **[uTinyRipper](https://github.com/mafaca/UtinyRipper) ⭐ 3,099 | 🐛 893 | 🌐 C# | 📅 2022-01-14** - *Unity asset extractor and exporter.*
...
* **[DBI Backend](https://github.com/rashevskyv/dbi) ⭐ 2,952 | 🐛 73 | 🌐 Python | 📅 2026-09-18** - *Nintendo Switch games installer (NSP, NSZ, XCI, XCZ) using DBI (MTP, USB, HTTP).*
...
* **[TegraRcmGUI](https://github.com/eliboa/TegraRcmGUI) ⭐ 2,307 | 🐛 24 | 🌐 C++ | 📅 2021-11-30** - *Nintendo Switch payload injector (RCM Mode).*
...
* **[Switch Theme Injector](https://github.com/exelix11/SwitchThemeInjector) ⭐ 1,240 | 🐛 24 | 🌐 C | 📅 2026-09-22** - *Custom themes creator for Nintendo Switch.*
* **[Joy-Con Toolkit](https://github.com/CTCaer/jc_toolkit) ⭐ 1,106 | 🐛 77 | 🌐 C++ | 📅 2024-05-07** - *Nintendo Switch Joy-Con toolkit.*
* **[NX Nand Manager](https://github.com/eliboa/NxNandManager) ⭐ 980 | 🐛 50 | 🌐 C++ | 📅 2026-09-11** - *Nintendo Switch NAND manager.*
...
* **[Nand Fix Pro](https://github.com/sthetix/NANDFixPro) ⭐ 125 | 🐛 2 | 🌐 Python | 📅 2026-09-25** - *Nintendo Switch NAND repair tool.*
...
* **[Logisim](https://github.com/logisim-evolution/logisim-evolution) ⭐ 7,653 | 🐛 110 | 🌐 Java | 📅 2026-09-22** - *Educational digital circuit simulator.*
* **[Arduino CLI](https://github.com/arduino/arduino-cli) ⭐ 5,041 | 🐛 274 | 🌐 Go | 📅 2026-09-25** - *Command-line interface for Arduino.*
...
* **[DevToys](https://github.com/DevToys-app/DevToys) ⭐ 32,029 | 🐛 341 | 🌐 C# | 📅 2026-02-25** - *A Swiss Army knife for developers.*
* **[Cmder](https://github.com/cmderdev/cmder) ⭐ 27,004 | 🐛 73 | 🌐 PowerShell | 📅 2026-09-21** - *Console emulator.*
...
* **[Sandboxie](https://github.com/sandboxie-plus/Sandboxie) ⭐ 19,544 | 🐛 751 | 🌐 C | 📅 2026-09-25** - *Enhanced version of the popular sandboxing program.*
* **[Cmake](https://github.com/Kitware/CMake) ⭐ 8,102 | 🐛 2 | 🌐 C | 📅 2026-09-25** - *C, C++ builder.*

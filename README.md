# Awesome ReVens: Reverse Engineering Toolkit AIO with stars
...
* Download latest ReVens from: [Releases](https://github.com/Jakiboy/ReVens/releases) ⭐ 353 | 🐛 0 | 🌐 JavaScript | 📅 2026-05-23.
...
* **[Yara](https://github.com/VirusTotal/yara) ⭐ 9,846 | 🐛 171 | 🌐 C | 📅 2026-08-25** - *Malware pattern matching tool.*
* **[Capa](https://github.com/mandiant/capa) ⭐ 6,172 | 🐛 298 | 🌐 Python | 📅 2026-09-01** - *Identify capabilities in executables.*
* **[PE-bear](https://github.com/hasherezade/pe-bear) ⭐ 3,794 | 🐛 16 | 🌐 C++ | 📅 2026-06-10** - *PE reversing tool.*
* **[ReverseKit](https://github.com/zer0condition/ReverseKit) ⭐ 780 | 🐛 0 | 🌐 C++ | 📅 2023-05-30** - *Comprehensive reverse engineering toolkit.*
...
* **[Detect It Easy (DiE)](https://github.com/horsicq/DIE-engine) ⭐ 3,254 | 🐛 13 | 🌐 C++ | 📅 2026-09-05** - *File type identifier.*
* **[Nauz File Detector](https://github.com/horsicq/Nauz-File-Detector) ⭐ 581 | 🐛 2 | 🌐 C++ | 📅 2026-09-02** - *Detects compiler tools.*
...
* **[Exeinfo PE (ASL)](https://github.com/ExeinfoASL/ASL) ⭐ 1,144 | 🐛 8 | 📅 2026-08-08** - *Detects packers and compressors.*
...
* **[Driver Store Explorer](https://github.com/lostindark/DriverStoreExplorer) ⭐ 11,571 | 🐛 23 | 🌐 C# | 📅 2026-08-31** - *Driver Store Explorer.*
...
* **[Regshot](https://github.com/Seabreg/Regshot) ⭐ 544 | 🐛 3 | 📅 2019-06-15** - *Registry snapshot and comparison utility.*
* **[NTLDD](https://github.com/LRN/ntldd) ⭐ 98 | 🐛 3 | 🌐 C | 📅 2019-04-29** - *List DLL dependencies for Windows executables.*
...
* **[PE-sieve](https://github.com/hasherezade/pe-sieve) ⭐ 3,880 | 🐛 7 | 🌐 C++ | 📅 2026-06-06** - *Scans a given process.*
* **[Hollows Hunter](https://github.com/hasherezade/hollows_hunter) ⭐ 2,402 | 🐛 2 | 🌐 C | 📅 2026-06-06** - *Scans running processes for code injection artifacts.*
...
* **[Volatility](https://github.com/volatilityfoundation/volatility) ⚠️ Archived** - *A memory forensics analysis platform.*
...
* **[Papercut](https://github.com/ChangemakerStudios/Papercut) ⭐ 3,330 | 🐛 4 | 🌐 C# | 📅 2026-08-23** - *Simple SMTP server for testing.*
* **[PacketSender](https://github.com/dannagle/PacketSender) ⭐ 2,675 | 🐛 67 | 🌐 C++ | 📅 2026-09-01** - *Send & receive TCP, UDP, SSL, DTLS. HTTP Requests.*
* **[HTTP Toolkit](https://github.com/httptoolkit/httptoolkit-desktop) ⭐ 727 | 🐛 18 | 🌐 TypeScript | 📅 2026-09-03** - *Intercept, view & edit any HTTP traffic.*
...
* **[SQLiteStudio](https://github.com/pawelsalawa/sqlitestudio) ⭐ 6,726 | 🐛 489 | 🌐 C | 📅 2026-08-24** - *SQLite database manager.*
* **[GrepWin (Text)](https://github.com/stefankueng/grepWin) ⭐ 2,067 | 🐛 48 | 🌐 C++ | 📅 2026-09-05** - *Search tool for Windows.*
* **[XMachO Viewer](https://github.com/horsicq/XMachOViewer) ⭐ 960 | 🐛 4 | 🌐 C++ | 📅 2026-09-05** - *Mac OS XMachO Viewer.*
...
* **[RHash](https://github.com/rhash/RHash) ⭐ 728 | 🐛 43 | 🌐 C | 📅 2026-04-11** - *Utility for computing hash sums.*
* **[XOpcodeCalc](https://github.com/horsicq/XOpcodeCalc) ⭐ 412 | 🐛 6 | 🌐 C++ | 📅 2026-09-02** - *Opcode calculator tool.*
...
* **[.NET Reactor Slayer](https://github.com/SychicBoy/NETReactorSlayer) ⭐ 1,261 | 🐛 27 | 🌐 C# | 📅 2024-07-12** - *Deobfuscator and unpacker for .NET Reactor.*
* **[MalUnpack](https://github.com/hasherezade/mal_unpack) ⭐ 837 | 🐛 1 | 🌐 C | 📅 2026-04-14** - *Dynamic unpacker for malware analysis.*
* **[GUnPacker](https://github.com/unipacker/unipacker) ⭐ 774 | 🐛 28 | 🌐 Python | 📅 2025-08-18** - *Generic unpacker.*
* **[Magicmida](https://github.com/Hendi48/Magicmida) ⭐ 702 | 🐛 18 | 🌐 Pascal | 📅 2026-05-14** - *Themida/WinLicense unpacker.*
* **[de4dot](https://github.com/ViRb3/de4dot-cex) ⚠️ Archived** - *.NET deobfuscator and unpacker.*
* **[IsXunpack](https://github.com/lifenjoiner/ISx) ⭐ 233 | 🐛 1 | 🌐 C | 📅 2025-07-07** - *InstallShield installer extractor.*
* **[ISx](https://github.com/lifenjoiner/ISx) ⭐ 233 | 🐛 1 | 🌐 C | 📅 2025-07-07** - *InstallShield installer extractor and unpacker.*
* **[ConfuserEx Unpacker](https://github.com/XenocodeRCE/ConfuserEx-Unpacker) ⭐ 76 | 🐛 0 | 🌐 C# | 📅 2017-07-11** - *Confuserex unpacker.*
...
* **[ASPack Unpacker](https://github.com/orcastor/unpack) ⭐ 81 | 🐛 2 | 🌐 Go | 📅 2025-12-21** - *Another ASPack unpacker.*
...
* **[ILProtector Unpacker](https://github.com/RexProg/ILProtectorUnpacker) ⭐ 113 | 🐛 1 | 🌐 C# | 📅 2020-08-30** - *ILProtector unpacker (.NET).*
* **[ILPUnpack](https://github.com/ElektroKill/ILPUnpack) ⭐ 29 | 🐛 0 | 🌐 C# | 📅 2023-02-24** - *ILProtector unpacker tool (.NET).*
...
* **[CyberChef](https://github.com/gchq/CyberChef) ⭐ 35,755 | 🐛 566 | 🌐 JavaScript | 📅 2026-09-05** - *Analyzing and decoding data.*
* **[RSA-Tool 2](https://github.com/ius/rsatool) ⭐ 1,659 | 🐛 2 | 🌐 Python | 📅 2026-07-20** - *Tool for generating and analyzing RSA keys.*
* **[RSATool](https://github.com/ius/rsatool) ⭐ 1,659 | 🐛 2 | 🌐 Python | 📅 2026-07-20** - *Generate, convert and analyze RSA keys.*
...
* **[SND Reverse Tool](https://github.com/sceners/snd-reverser-tool) ⭐ 4 | 🐛 0 | 🌐 Assembly | 📅 2022-05-30** - *Reverse engineering tool for Windows binaries.*
* **[RSABox](https://github.com/ohEmily/RSA_accelerator) ⭐ 0 | 🐛 2 | 🌐 C | 📅 2016-05-11** - *Toolkit for working with RSA encryption.*
...
* **[UEFITool](https://github.com/LongSoft/UEFITool) ⭐ 5,657 | 🐛 23 | 🌐 C | 📅 2026-07-29** - *UEFI firmware image viewer and editor.*
* **[UniExtract](https://github.com/Bioruebe/UniExtract2) ⭐ 4,413 | 🐛 123 | 🌐 AutoIt | 📅 2024-07-06** - *Universal archive extractor.*
* **[PDBRipper](https://github.com/horsicq/PDBRipper/) ⭐ 903 | 🐛 18 | 🌐 C++ | 📅 2026-09-02** - *PDB file ripper and information extractor.*
* **[Ratr](https://github.com/Jakiboy/Ratr) ⭐ 24 | 🐛 0 | 🌐 C# | 📅 2026-08-05** - *Router Config Extractor.*
...
* **[LessMSI](https://github.com/activescott/lessmsi) ⭐ 1,759 | 🐛 55 | 🌐 C# | 📅 2026-04-02** - *Command-line tool to extract data from MSI files.*
...
* **[RegRipper](https://github.com/keydet89/RegRipper3.0) ⭐ 716 | 🐛 9 | 🌐 Perl | 📅 2026-05-27** - *Another registry extractor.*
...
* **[x64dbg](https://github.com/x64dbg/x64dbg) ⭐ 49,412 | 🐛 576 | 🌐 C++ | 📅 2026-08-30** - *Graphical debugger for x86 and x86-64 executables.*
* **[dnSpy](https://github.com/dnSpy/dnSpy) ⚠️ Archived** - *.NET assembly editor, decompiler, and debugger.*
* **[Radare2](https://github.com/radareorg/radare2) ⭐ 24,745 | 🐛 818 | 🌐 C | 📅 2026-09-06** - *A portable and multi-architecture reverse engineering framework.*
* **[Cutter](https://github.com/rizinorg/cutter) ⭐ 19,678 | 🐛 493 | 🌐 C++ | 📅 2026-08-22** - *Free and open-source reverse engineering platform.*
...
* **[Ghidra](https://github.com/NationalSecurityAgency/ghidra) ⭐ 74,428 | 🐛 1,939 | 🌐 Java | 📅 2026-09-02** - *Open-source software reverse engineering suite.*
* **[Capstone](https://github.com/capstone-engine/capstone) ⭐ 8,999 | 🐛 358 | 🌐 C | 📅 2026-09-04** - *Lightweight multi-architecture disassembly framework.*
* **[WABT](https://github.com/WebAssembly/wabt) ⭐ 8,119 | 🐛 231 | 🌐 C++ | 📅 2026-08-30** - *WebAssembly Binary Toolkit - disassembler and tools.*
* **[Bddisasm](https://github.com/bitdefender/bddisasm) ⭐ 1,085 | 🐛 0 | 🌐 C | 📅 2026-06-29** - *Binary Ninja's disassembly library.*
...
* **[JADX](https://github.com/skylot/jadx) ⭐ 50,356 | 🐛 447 | 🌐 Java | 📅 2026-09-02** - *Dex to Java decompiler.*
* **[ILSpy](https://github.com/icsharpcode/ILSpy) ⭐ 26,020 | 🐛 170 | 🌐 C# | 📅 2026-09-05** - *Open-source .NET assembly browser.*
* **[Bytecode Viewer](https://github.com/Konloch/bytecode-viewer) ⭐ 15,629 | 🐛 103 | 🌐 Java | 📅 2026-07-17** - *Decompile Java/Android bytecode & more.*
* **[JD-GUI](https://github.com/java-decompiler/jd-gui) ⭐ 15,194 | 🐛 248 | 🌐 Java | 📅 2024-07-08** - *Decompile Java class files.*
* **[FFDec](https://github.com/jindrapetrik/jpexs-decompiler) ⭐ 5,848 | 🐛 5 | 🌐 Java | 📅 2026-08-08** - *Flash Decompiler.*
...
* **[ImHex](https://github.com/WerWolv/ImHex) ⭐ 54,710 | 🐛 393 | 🌐 C++ | 📅 2026-09-06** - *A fast and powerful hex editor.*
...
* **[Frida](https://github.com/frida/frida) ⭐ 21,849 | 🐛 1,960 | 🌐 Meson | 📅 2026-09-05** - *Dynamic instrumentation toolkit.*
* **[Cheat Engine](https://github.com/cheat-engine/cheat-engine) ⭐ 19,132 | 🐛 1,307 | 🌐 Pascal | 📅 2025-04-19** - *Memory scanner/debugger for games and applications.*
* **[ReClass.NET](https://github.com/ReClassNET/ReClass.NET) ⭐ 2,194 | 🐛 84 | 🌐 C# | 📅 2024-05-10** - *.Net structure class reverser.*
* **[XELFViewer](https://github.com/horsicq/XELFViewer) ⭐ 1,584 | 🐛 8 | 🌐 C++ | 📅 2026-09-05** - *ELF files viewer and editor.*
* **[Scylla](https://github.com/NtQuery/Scylla) ⭐ 1,424 | 🐛 23 | 🌐 C++ | 📅 2023-04-05** - *Powerful and advanced x86/x86-64 executable unpacker.*
* **[XPEViewer](https://github.com/horsicq/XPEViewer) ⭐ 1,230 | 🐛 5 | 🌐 QMake | 📅 2026-09-05** - *Executable file viewer and editor.*
* **[PE Tools](https://github.com/petoolse/petools) ⭐ 1,197 | 🐛 10 | 📅 2025-10-21** - *PE manipulation toolkit.*
* **[KDiff3](https://github.com/KDE/kdiff3) ⭐ 614 | 🐛 0 | 🌐 C++ | 📅 2026-09-03** - *File and directory diff and merge tool.*
...
* **[EasyHook](https://github.com/EasyHook/EasyHook) ⭐ 3,293 | 🐛 186 | 🌐 C | 📅 2024-01-25** - *Windows API Hooking framework.*
* **[Xenos](https://github.com/DarthTon/Xenos) ⭐ 2,655 | 🐛 51 | 🌐 C++ | 📅 2021-05-17** - *DLL injector.*
...
* **[Exiftool](https://github.com/exiftool/exiftool) ⭐ 5,008 | 🐛 42 | 🌐 Perl | 📅 2026-05-27** - *Meta data editor.*
* **[Far Manager](https://github.com/FarGroup/FarManager) ⭐ 2,221 | 🐛 156 | 🌐 C++ | 📅 2026-09-05** - *Text-based file and archive manager for Windows.*
* **[Steghide](https://github.com/StefanoDeVuono/steghide) ⭐ 775 | 🐛 4 | 🌐 C++ | 📅 2024-02-20** - *Hide data in images and audio.*
* **[PDF Metadata Editor](https://github.com/zaro/pdf-metadata-editor) ⭐ 227 | 🐛 5 | 🌐 Java | 📅 2026-08-09** - *Open Source PDF Metadata Editor.*
...
* **[WinSCP](https://github.com/winscp/winscp) ⭐ 3,821 | 🐛 1 | 🌐 C | 📅 2026-09-03** - *Free SFTP, SCP, and FTP client for Windows.*
...
* **[XDELTA Patch Maker](https://github.com/jmacd/xdelta) ⭐ 1,342 | 🐛 109 | 🌐 C | 📅 2026-09-03** - *Patch creator for Inno Setup installers.*
...
* **[MilkyTracker](https://github.com/milkytracker/MilkyTracker) ⭐ 2,095 | 🐛 87 | 🌐 C++ | 📅 2026-06-22** - *Multi-platform music tracker inspired by FastTracker 2.*
* **[OpenMPT](https://github.com/OpenMPT/openmpt) ⭐ 770 | 🐛 3 | 🌐 C++ | 📅 2026-08-29** - *Open-source tracker software.*
* **[ProTracker](https://github.com/8bitbubsy/pt2-clone) ⭐ 662 | 🐛 7 | 🌐 C | 📅 2026-08-21** - *Classic Amiga music tracker software.*
...
* **[Nasm](https://github.com/netwide-assembler/nasm) ⭐ 3,308 | 🐛 70 | 🌐 Assembly | 📅 2026-08-19** - *Netwide Assembler for x86 architecture.*
...
* **[ScyllaHide](https://github.com/x64dbg/ScyllaHide) ⭐ 4,281 | 🐛 53 | 🌐 C++ | 📅 2024-06-04** - *Anti-(anti-debugger).*
...
* **[ConfuserEx](https://github.com/mkaring/ConfuserEx) ⭐ 2,904 | 🐛 103 | 🌐 C# | 📅 2024-06-07** - *Open-source protector for .NET applications.*
...
* **[ProGuard](https://github.com/Guardsquare/proguard) ⭐ 3,646 | 🐛 176 | 🌐 Java | 📅 2026-08-24** - *Java optimizer and obfuscator.*
...
* **[UPX](https://github.com/upx/upx) ⭐ 17,853 | 🐛 24 | 🌐 C++ | 📅 2026-09-04** - *Free, portable, and extendable executable packer.*
...
* **[Etcher](https://github.com/balena-io/etcher) ⭐ 34,302 | 🐛 689 | 🌐 TypeScript | 📅 2026-06-02** - *A cross-platform tool to flash OS images onto SD cards and USB.*
* **[OTP Extractor](https://github.com/scito/extract_otp_secrets) ⭐ 1,652 | 🐛 4 | 🌐 Python | 📅 2026-09-04** - *Tool for extracting OTPs (One-Time Passwords).*
...
* **[Apktool](https://github.com/iBotPeaches/Apktool) ⭐ 25,469 | 🐛 76 | 🌐 Java | 📅 2026-09-04** - *Tool for decompiling and recompiling Android APK files.*
* **[APK Editor Studio](https://github.com/kefir500/apk-editor-studio) ⭐ 1,648 | 🐛 55 | 🌐 C++ | 📅 2025-01-19** - *Powerful APK editing tool.*
* **[Bifrost](https://github.com/zacharee/Bifrost) ⭐ 1,570 | 🐛 3 | 🌐 Kotlin | 📅 2026-09-05** - *Tool for downloading Samsung mobile device firmware.*
* **[Frija](https://github.com/SlackingVeteran/frija) ⭐ 743 | 🐛 0 | 📅 2026-05-22** - *Tool for downloading Samsung firmware.*
* **[XAPK Detector](https://github.com/horsicq/XAPKDetector) ⭐ 693 | 🐛 1 | 🌐 C++ | 📅 2026-09-02** - *Detects and handles XAPK files.*
...
* **[Checkn1x (ISO)](https://github.com/asineth0/checkn1x) ⭐ 625 | 🐛 1 | 🌐 Shell | 📅 2023-01-11** - *Jailbreaking iOS devices bootable ISO.*
...
* **[Dragon UnPACKer](https://github.com/elbereth/DragonUnPACKer) ⭐ 255 | 🐛 120 | 🌐 Pascal | 📅 2024-06-05** - *Tool for opening and extracting game resource files.*
...
* **[Quark](https://github.com/XorTroll/Goldleaf) ⭐ 3,033 | 🐛 90 | 🌐 C | 📅 2026-08-20** - *Nintendo Switch games installer using Goldleaf.*
* **[DBI Backend](https://github.com/rashevskyv/dbi) ⭐ 2,933 | 🐛 73 | 🌐 Python | 📅 2026-07-17** - *Nintendo Switch games installer (NSP, NSZ, XCI, XCZ) using DBI (MTP, USB, HTTP).*
* **[NS-USBloader](https://github.com/developersu/ns-usbloader) ⭐ 2,328 | 🐛 50 | 🌐 Java | 📅 2026-08-27** - *Nintendo Switch games installer using Awoo-Installer.*
* **[TegraRcmGUI](https://github.com/eliboa/TegraRcmGUI) ⭐ 2,300 | 🐛 24 | 🌐 C++ | 📅 2021-11-30** - *Nintendo Switch payload injector (RCM Mode).*
* **[SysDVR](https://github.com/exelix11/SysDVR) ⭐ 2,017 | 🐛 12 | 🌐 C++ | 📅 2026-07-16** - *Nintendo Switch streaming client.*
* **[Switch LAN Play](https://github.com/spacemeowx2/switch-lan-play) ⭐ 2,015 | 🐛 62 | 🌐 C | 📅 2025-03-21** - *Nintendo Switch LAN client.*
* **[Appstore](https://github.com/fortheusers/hb-appstore) ⭐ 1,454 | 🐛 27 | 🌐 C++ | 📅 2026-07-08** - *GUI Homebrew app store for CFW.*
* **[NXDT Host](https://github.com/DarkMatterCore/nxdumptool) ⭐ 1,288 | 🐛 19 | 🌐 C | 📅 2026-08-04** - *Nintendo Switch dump tool server.*
* **[NUT](https://github.com/blawar/nut) ⭐ 1,269 | 🐛 76 | 🌐 Python | 📅 2026-01-19** - *Nintendo Switch games installer using Tinfoil.*
* **[Switch Theme Injector](https://github.com/exelix11/SwitchThemeInjector) ⭐ 1,238 | 🐛 25 | 🌐 C | 📅 2026-08-27** - *Custom themes creator for Nintendo Switch.*
* **[Joy-Con Toolkit](https://github.com/CTCaer/jc_toolkit) ⭐ 1,101 | 🐛 77 | 🌐 C++ | 📅 2024-05-07** - *Nintendo Switch Joy-Con toolkit.*
* **[NX Nand Manager](https://github.com/eliboa/NxNandManager) ⭐ 971 | 🐛 50 | 🌐 C++ | 📅 2026-06-17** - *Nintendo Switch NAND manager.*
* **[Fluffy](https://github.com/fourminute/Fluffy) ⭐ 270 | 🐛 3 | 🌐 Python | 📅 2023-08-21** - *Nintendo Switch games server installer using TinFoil or Goldleaf.*
...
* **[Nand Fix Pro](https://github.com/sthetix/NANDFixPro) ⭐ 120 | 🐛 2 | 🌐 Python | 📅 2026-06-23** - *Nintendo Switch NAND repair tool.*
* **[NX Editor](https://github.com/NX-Editor/NxEditor) ⭐ 100 | 🐛 9 | 🌐 C# | 📅 2026-05-09** - *General editor for Nintendo Switch.*
* **[EmuTool](https://github.com/TheyKilledKenny/Emutool) ⭐ 91 | 🐛 2 | 🌐 Visual Basic 6.0 | 📅 2024-02-02** - *EmuNAND/EmuMMC manager.*
* **[LayoutKit](https://github.com/ThemezerNX/LayoutKit) ⭐ 31 | 🐛 3 | 🌐 Vue | 📅 2026-05-21** - *Layouts creator for Nintendo Switch.*
* **[EX BootLogo](https://github.com/KranKRival/EX-BootLogo-Nintendo-Switch-Bootlogo-Converter) ⭐ 30 | 🐛 1 | 🌐 C# | 📅 2019-06-08** - *Nintendo Switch boot logo converter (Hekate/Atmosphere).*
...
* **[Logisim](https://github.com/logisim-evolution/logisim-evolution) ⭐ 7,526 | 🐛 100 | 🌐 Java | 📅 2026-09-05** - *Educational digital circuit simulator.*
* **[Arduino CLI](https://github.com/arduino/arduino-cli) ⭐ 5,015 | 🐛 263 | 🌐 Go | 📅 2026-09-04** - *Command-line interface for Arduino.*
* **[Fritzing](https://github.com/fritzing/fritzing-app) ⭐ 4,797 | 🐛 495 | 🌐 C++ | 📅 2026-08-12** - *An open-source electronics design software.*
* **[PICSimLab](https://github.com/lcgamboa/picsimlab) ⭐ 662 | 🐛 9 | 🌐 C++ | 📅 2026-08-31** - *PIC microcontroller simulator.*
* **[SimulIDE](https://github.com/simulide/simulide) ⭐ 304 | 🐛 23 | 🌐 C++ | 📅 2021-11-04** - *Real-time electronics simulator.*
...
* **[DevToys](https://github.com/DevToys-app/DevToys) ⭐ 31,930 | 🐛 341 | 🌐 C# | 📅 2026-02-25** - *A Swiss Army knife for developers.*
* **[Cmder](https://github.com/cmderdev/cmder) ⭐ 27,001 | 🐛 67 | 🌐 PowerShell | 📅 2026-08-31** - *Console emulator.*
* **[Dev-C++](https://github.com/Embarcadero/Dev-Cpp) ⭐ 2,995 | 🐛 214 | 🌐 Pascal | 📅 2024-06-17** - *A fast, portable, simple, and free C/C++ IDE.*
* **[PyScripter](https://github.com/pyscripter/pyscripter) ⭐ 1,250 | 🐛 50 | 🌐 Pascal | 📅 2025-11-24** - *Free and open-source Python integrated development environment (IDE).*
...
* **[Sandboxie](https://github.com/sandboxie-plus/Sandboxie) ⭐ 19,352 | 🐛 742 | 🌐 C | 📅 2026-09-04** - *Enhanced version of the popular sandboxing program.*
* **[Cmake](https://github.com/Kitware/CMake) ⭐ 8,056 | 🐛 2 | 🌐 C | 📅 2026-09-05** - *C, C++ builder.*
* **[Npcap](https://github.com/nmap/npcap) ⭐ 3,585 | 🐛 243 | 🌐 C | 📅 2026-05-28** - *Packet capture library installer.*
* **[MSYS2](https://github.com/nmap/npcap) ⭐ 3,585 | 🐛 243 | 🌐 C | 📅 2026-05-28** - *Unix SDK installer for Windows.*

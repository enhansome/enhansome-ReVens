...
* **[Yara](https://github.com/VirusTotal/yara) ⭐ 9,848 | 🐛 171 | 🌐 C | 📅 2026-08-25** - *Malware pattern matching tool.*
* **[Capa](https://github.com/mandiant/capa) ⭐ 6,170 | 🐛 298 | 🌐 Python | 📅 2026-09-01** - *Identify capabilities in executables.*
* **[PE-bear](https://github.com/hasherezade/pe-bear) ⭐ 3,793 | 🐛 16 | 🌐 C++ | 📅 2026-06-10** - *PE reversing tool.*
...
* **[Detect It Easy (DiE)](https://github.com/horsicq/DIE-engine) ⭐ 3,253 | 🐛 13 | 🌐 C++ | 📅 2026-09-03** - *File type identifier.*
...
* **[Driver Store Explorer](https://github.com/lostindark/DriverStoreExplorer) ⭐ 11,568 | 🐛 23 | 🌐 C# | 📅 2026-08-31** - *Driver Store Explorer.*
...
* **[HTTP Toolkit](https://github.com/httptoolkit/httptoolkit-desktop) ⭐ 726 | 🐛 18 | 🌐 TypeScript | 📅 2026-09-03** - *Intercept, view & edit any HTTP traffic.*
...
* **[SQLiteStudio](https://github.com/pawelsalawa/sqlitestudio) ⭐ 6,725 | 🐛 489 | 🌐 C | 📅 2026-08-24** - *SQLite database manager.*
* **[GrepWin (Text)](https://github.com/stefankueng/grepWin) ⭐ 2,066 | 🐛 47 | 🌐 C++ | 📅 2026-09-04** - *Search tool for Windows.*
* **[XMachO Viewer](https://github.com/horsicq/XMachOViewer) ⭐ 961 | 🐛 4 | 🌐 C++ | 📅 2026-09-04** - *Mac OS XMachO Viewer.*
...
* **[CyberChef](https://github.com/gchq/CyberChef) ⭐ 35,748 | 🐛 567 | 🌐 JavaScript | 📅 2026-09-04** - *Analyzing and decoding data.*
...
* **[UEFITool](https://github.com/LongSoft/UEFITool) ⭐ 5,656 | 🐛 23 | 🌐 C | 📅 2026-07-29** - *UEFI firmware image viewer and editor.*
...
* **[LessMSI](https://github.com/activescott/lessmsi) ⭐ 1,758 | 🐛 55 | 🌐 C# | 📅 2026-04-02** - *Command-line tool to extract data from MSI files.*
...
* **[x64dbg](https://github.com/x64dbg/x64dbg) ⭐ 49,402 | 🐛 576 | 🌐 C++ | 📅 2026-08-30** - *Graphical debugger for x86 and x86-64 executables.*
* **[dnSpy](https://github.com/dnSpy/dnSpy) ⚠️ Archived** - *.NET assembly editor, decompiler, and debugger.*
* **[Radare2](https://github.com/radareorg/radare2) ⭐ 24,738 | 🐛 827 | 🌐 C | 📅 2026-09-04** - *A portable and multi-architecture reverse engineering framework.*
* **[Cutter](https://github.com/rizinorg/cutter) ⭐ 19,672 | 🐛 493 | 🌐 C++ | 📅 2026-08-22** - *Free and open-source reverse engineering platform.*
...
* **[Ghidra](https://github.com/NationalSecurityAgency/ghidra) ⭐ 74,384 | 🐛 1,938 | 🌐 Java | 📅 2026-09-02** - *Open-source software reverse engineering suite.*
...
* **[WABT](https://github.com/WebAssembly/wabt) ⭐ 8,117 | 🐛 231 | 🌐 C++ | 📅 2026-08-30** - *WebAssembly Binary Toolkit - disassembler and tools.*
...
* **[JADX](https://github.com/skylot/jadx) ⭐ 50,345 | 🐛 444 | 🌐 Java | 📅 2026-09-02** - *Dex to Java decompiler.*
* **[ILSpy](https://github.com/icsharpcode/ILSpy) ⭐ 26,015 | 🐛 176 | 🌐 C# | 📅 2026-09-04** - *Open-source .NET assembly browser.*
* **[Bytecode Viewer](https://github.com/Konloch/bytecode-viewer) ⭐ 15,630 | 🐛 103 | 🌐 Java | 📅 2026-07-17** - *Decompile Java/Android bytecode & more.*
* **[JD-GUI](https://github.com/java-decompiler/jd-gui) ⭐ 15,192 | 🐛 248 | 🌐 Java | 📅 2024-07-08** - *Decompile Java class files.*
* **[FFDec](https://github.com/jindrapetrik/jpexs-decompiler) ⭐ 5,845 | 🐛 5 | 🌐 Java | 📅 2026-08-08** - *Flash Decompiler.*
...
* **[ImHex](https://github.com/WerWolv/ImHex) ⭐ 54,694 | 🐛 393 | 🌐 C++ | 📅 2026-09-05** - *A fast and powerful hex editor.*
...
* **[Frida](https://github.com/frida/frida) ⭐ 21,842 | 🐛 1,960 | 🌐 Meson | 📅 2026-09-04** - *Dynamic instrumentation toolkit.*
* **[Cheat Engine](https://github.com/cheat-engine/cheat-engine) ⭐ 19,119 | 🐛 1,307 | 🌐 Pascal | 📅 2025-04-19** - *Memory scanner/debugger for games and applications.*
* **[ReClass.NET](https://github.com/ReClassNET/ReClass.NET) ⭐ 2,194 | 🐛 84 | 🌐 C# | 📅 2024-05-10** - *.Net structure class reverser.*
* **[XELFViewer](https://github.com/horsicq/XELFViewer) ⭐ 1,584 | 🐛 8 | 🌐 C++ | 📅 2026-09-04** - *ELF files viewer and editor.*
* **[Scylla](https://github.com/NtQuery/Scylla) ⭐ 1,423 | 🐛 23 | 🌐 C++ | 📅 2023-04-05** - *Powerful and advanced x86/x86-64 executable unpacker.*
* **[XPEViewer](https://github.com/horsicq/XPEViewer) ⭐ 1,229 | 🐛 5 | 🌐 QMake | 📅 2026-09-04** - *Executable file viewer and editor.*
...
* **[Xenos](https://github.com/DarthTon/Xenos) ⭐ 2,652 | 🐛 51 | 🌐 C++ | 📅 2021-05-17** - *DLL injector.*
...
* **[Exiftool](https://github.com/exiftool/exiftool) ⭐ 5,006 | 🐛 42 | 🌐 Perl | 📅 2026-05-27** - *Meta data editor.*
* **[Far Manager](https://github.com/FarGroup/FarManager) ⭐ 2,219 | 🐛 156 | 🌐 C++ | 📅 2026-09-04** - *Text-based file and archive manager for Windows.*
...
* **[Nasm](https://github.com/netwide-assembler/nasm) ⭐ 3,306 | 🐛 70 | 🌐 Assembly | 📅 2026-08-19** - *Netwide Assembler for x86 architecture.*
...
* **[ScyllaHide](https://github.com/x64dbg/ScyllaHide) ⭐ 4,282 | 🐛 52 | 🌐 C++ | 📅 2024-06-04** - *Anti-(anti-debugger).*
...
* **[ProGuard](https://github.com/Guardsquare/proguard) ⭐ 3,645 | 🐛 176 | 🌐 Java | 📅 2026-08-24** - *Java optimizer and obfuscator.*
...
* **[UPX](https://github.com/upx/upx) ⭐ 17,850 | 🐛 25 | 🌐 C++ | 📅 2026-09-04** - *Free, portable, and extendable executable packer.*
...
* **[Etcher](https://github.com/balena-io/etcher) ⭐ 34,300 | 🐛 689 | 🌐 TypeScript | 📅 2026-06-02** - *A cross-platform tool to flash OS images onto SD cards and USB.*
...
* **[Apktool](https://github.com/iBotPeaches/Apktool) ⭐ 25,461 | 🐛 76 | 🌐 Java | 📅 2026-09-04** - *Tool for decompiling and recompiling Android APK files.*
* **[APK Editor Studio](https://github.com/kefir500/apk-editor-studio) ⭐ 1,649 | 🐛 55 | 🌐 C++ | 📅 2025-01-19** - *Powerful APK editing tool.*
* **[Bifrost](https://github.com/zacharee/Bifrost) ⭐ 1,568 | 🐛 3 | 🌐 Kotlin | 📅 2026-09-04** - *Tool for downloading Samsung mobile device firmware.*
* **[Frija](https://github.com/SlackingVeteran/frija) ⭐ 742 | 🐛 0 | 📅 2026-05-22** - *Tool for downloading Samsung firmware.*
...
* **[DBI Backend](https://github.com/rashevskyv/dbi) ⭐ 2,932 | 🐛 73 | 🌐 Python | 📅 2026-07-17** - *Nintendo Switch games installer (NSP, NSZ, XCI, XCZ) using DBI (MTP, USB, HTTP).*
...
* **[TegraRcmGUI](https://github.com/eliboa/TegraRcmGUI) ⭐ 2,299 | 🐛 24 | 🌐 C++ | 📅 2021-11-30** - *Nintendo Switch payload injector (RCM Mode).*
...
* **[Appstore](https://github.com/fortheusers/hb-appstore) ⭐ 1,453 | 🐛 27 | 🌐 C++ | 📅 2026-07-08** - *GUI Homebrew app store for CFW.*
...
* **[Logisim](https://github.com/logisim-evolution/logisim-evolution) ⭐ 7,527 | 🐛 106 | 🌐 Java | 📅 2026-09-04** - *Educational digital circuit simulator.*
* **[Arduino CLI](https://github.com/arduino/arduino-cli) ⭐ 5,013 | 🐛 263 | 🌐 Go | 📅 2026-09-04** - *Command-line interface for Arduino.*
* **[Fritzing](https://github.com/fritzing/fritzing-app) ⭐ 4,795 | 🐛 495 | 🌐 C++ | 📅 2026-08-12** - *An open-source electronics design software.*
...
* **[DevToys](https://github.com/DevToys-app/DevToys) ⭐ 31,924 | 🐛 341 | 🌐 C# | 📅 2026-02-25** - *A Swiss Army knife for developers.*
...
* **[Sandboxie](https://github.com/sandboxie-plus/Sandboxie) ⭐ 19,343 | 🐛 741 | 🌐 C | 📅 2026-09-04** - *Enhanced version of the popular sandboxing program.*
* **[Cmake](https://github.com/Kitware/CMake) ⭐ 8,056 | 🐛 2 | 🌐 C | 📅 2026-09-04** - *C, C++ builder.*

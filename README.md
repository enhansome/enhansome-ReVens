...
* **[Yara](https://github.com/VirusTotal/yara) ⭐ 9,871 | 🐛 170 | 🌐 C | 📅 2026-08-25** - *Malware pattern matching tool.*
* **[Capa](https://github.com/mandiant/capa) ⭐ 6,186 | 🐛 307 | 🌐 Python | 📅 2026-09-14** - *Identify capabilities in executables.*
...
* **[Driver Store Explorer](https://github.com/lostindark/DriverStoreExplorer) ⭐ 11,675 | 🐛 24 | 🌐 C# | 📅 2026-09-16** - *Driver Store Explorer.*
...
* **[Hollows Hunter](https://github.com/hasherezade/hollows_hunter) ⭐ 2,406 | 🐛 2 | 🌐 C | 📅 2026-06-06** - *Scans running processes for code injection artifacts.*
...
* **[HTTP Toolkit](https://github.com/httptoolkit/httptoolkit-desktop) ⭐ 732 | 🐛 18 | 🌐 TypeScript | 📅 2026-09-14** - *Intercept, view & edit any HTTP traffic.*
...
* **[SQLiteStudio](https://github.com/pawelsalawa/sqlitestudio) ⭐ 6,748 | 🐛 491 | 🌐 C | 📅 2026-09-17** - *SQLite database manager.*
* **[GrepWin (Text)](https://github.com/stefankueng/grepWin) ⭐ 2,071 | 🐛 48 | 🌐 C++ | 📅 2026-09-05** - *Search tool for Windows.*
* **[XMachO Viewer](https://github.com/horsicq/XMachOViewer) ⭐ 963 | 🐛 4 | 🌐 C++ | 📅 2026-09-17** - *Mac OS XMachO Viewer.*
...
* **[.NET Reactor Slayer](https://github.com/SychicBoy/NETReactorSlayer) ⭐ 1,262 | 🐛 31 | 🌐 C# | 📅 2026-09-12** - *Deobfuscator and unpacker for .NET Reactor.*
* **[MalUnpack](https://github.com/hasherezade/mal_unpack) ⭐ 842 | 🐛 1 | 🌐 C | 📅 2026-04-14** - *Dynamic unpacker for malware analysis.*
* **[GUnPacker](https://github.com/unipacker/unipacker) ⭐ 776 | 🐛 28 | 🌐 Python | 📅 2025-08-18** - *Generic unpacker.*
...
* **[CyberChef](https://github.com/gchq/CyberChef) ⭐ 35,867 | 🐛 593 | 🌐 JavaScript | 📅 2026-09-16** - *Analyzing and decoding data.*
...
* **[UEFITool](https://github.com/LongSoft/UEFITool) ⭐ 5,677 | 🐛 23 | 🌐 C | 📅 2026-07-29** - *UEFI firmware image viewer and editor.*
...
* **[x64dbg](https://github.com/x64dbg/x64dbg) ⭐ 49,539 | 🐛 573 | 🌐 C++ | 📅 2026-09-14** - *Graphical debugger for x86 and x86-64 executables.*
* **[dnSpy](https://github.com/dnSpy/dnSpy) ⚠️ Archived** - *.NET assembly editor, decompiler, and debugger.*
* **[Radare2](https://github.com/radareorg/radare2) ⭐ 24,821 | 🐛 824 | 🌐 C | 📅 2026-09-16** - *A portable and multi-architecture reverse engineering framework.*
* **[Cutter](https://github.com/rizinorg/cutter) ⭐ 19,741 | 🐛 494 | 🌐 C++ | 📅 2026-09-11** - *Free and open-source reverse engineering platform.*
...
* **[Ghidra](https://github.com/NationalSecurityAgency/ghidra) ⭐ 78,496 | 🐛 1,961 | 🌐 Java | 📅 2026-09-17** - *Open-source software reverse engineering suite.*
* **[Capstone](https://github.com/capstone-engine/capstone) ⭐ 9,024 | 🐛 357 | 🌐 C | 📅 2026-09-15** - *Lightweight multi-architecture disassembly framework.*
* **[WABT](https://github.com/WebAssembly/wabt) ⭐ 8,130 | 🐛 232 | 🌐 C++ | 📅 2026-09-17** - *WebAssembly Binary Toolkit - disassembler and tools.*
...
* **[JADX](https://github.com/skylot/jadx) ⭐ 50,501 | 🐛 449 | 🌐 Java | 📅 2026-09-12** - *Dex to Java decompiler.*
* **[ILSpy](https://github.com/icsharpcode/ILSpy) ⭐ 26,091 | 🐛 174 | 🌐 C# | 📅 2026-09-17** - *Open-source .NET assembly browser.*
* **[Bytecode Viewer](https://github.com/Konloch/bytecode-viewer) ⭐ 15,647 | 🐛 103 | 🌐 Java | 📅 2026-07-17** - *Decompile Java/Android bytecode & more.*
* **[JD-GUI](https://github.com/java-decompiler/jd-gui) ⭐ 15,198 | 🐛 248 | 🌐 Java | 📅 2024-07-08** - *Decompile Java class files.*
* **[FFDec](https://github.com/jindrapetrik/jpexs-decompiler) ⭐ 5,875 | 🐛 2 | 🌐 Java | 📅 2026-09-17** - *Flash Decompiler.*
...
* **[ImHex](https://github.com/WerWolv/ImHex) ⭐ 54,827 | 🐛 402 | 🌐 C++ | 📅 2026-09-18** - *A fast and powerful hex editor.*
...
* **[Frida](https://github.com/frida/frida) ⭐ 21,956 | 🐛 1,964 | 🌐 Meson | 📅 2026-09-16** - *Dynamic instrumentation toolkit.*
* **[Cheat Engine](https://github.com/cheat-engine/cheat-engine) ⭐ 19,183 | 🐛 1,309 | 🌐 Pascal | 📅 2025-04-19** - *Memory scanner/debugger for games and applications.*
* **[ReClass.NET](https://github.com/ReClassNET/ReClass.NET) ⭐ 2,204 | 🐛 84 | 🌐 C# | 📅 2024-05-10** - *.Net structure class reverser.*
* **[XELFViewer](https://github.com/horsicq/XELFViewer) ⭐ 1,585 | 🐛 8 | 🌐 C++ | 📅 2026-09-17** - *ELF files viewer and editor.*
* **[Scylla](https://github.com/NtQuery/Scylla) ⭐ 1,431 | 🐛 23 | 🌐 C++ | 📅 2023-04-05** - *Powerful and advanced x86/x86-64 executable unpacker.*
* **[XPEViewer](https://github.com/horsicq/XPEViewer) ⭐ 1,233 | 🐛 5 | 🌐 QMake | 📅 2026-09-17** - *Executable file viewer and editor.*
...
* **[Exiftool](https://github.com/exiftool/exiftool) ⭐ 5,052 | 🐛 43 | 🌐 Perl | 📅 2026-05-27** - *Meta data editor.*
* **[Far Manager](https://github.com/FarGroup/FarManager) ⭐ 2,224 | 🐛 156 | 🌐 C++ | 📅 2026-09-17** - *Text-based file and archive manager for Windows.*
...
* **[WinSCP](https://github.com/winscp/winscp) ⭐ 3,837 | 🐛 1 | 🌐 C | 📅 2026-09-12** - *Free SFTP, SCP, and FTP client for Windows.*
...
* **[XDELTA Patch Maker](https://github.com/jmacd/xdelta) ⭐ 1,353 | 🐛 107 | 🌐 C | 📅 2026-09-06** - *Patch creator for Inno Setup installers.*
...
* **[ProTracker](https://github.com/8bitbubsy/pt2-clone) ⭐ 664 | 🐛 7 | 🌐 C | 📅 2026-09-17** - *Classic Amiga music tracker software.*
...
* **[Nasm](https://github.com/netwide-assembler/nasm) ⭐ 3,313 | 🐛 74 | 🌐 Assembly | 📅 2026-08-19** - *Netwide Assembler for x86 architecture.*
...
* **[ScyllaHide](https://github.com/x64dbg/ScyllaHide) ⭐ 4,304 | 🐛 53 | 🌐 C++ | 📅 2024-06-04** - *Anti-(anti-debugger).*
...
* **[UPX](https://github.com/upx/upx) ⭐ 17,877 | 🐛 20 | 🌐 C++ | 📅 2026-09-17** - *Free, portable, and extendable executable packer.*
...
* **[Etcher](https://github.com/balena-io/etcher) ⭐ 34,365 | 🐛 693 | 🌐 TypeScript | 📅 2026-06-02** - *A cross-platform tool to flash OS images onto SD cards and USB.*
* **[OTP Extractor](https://github.com/scito/extract_otp_secrets) ⭐ 1,658 | 🐛 3 | 🌐 Python | 📅 2026-09-12** - *Tool for extracting OTPs (One-Time Passwords).*
...
* **[Apktool](https://github.com/iBotPeaches/Apktool) ⭐ 25,592 | 🐛 78 | 🌐 Java | 📅 2026-09-17** - *Tool for decompiling and recompiling Android APK files.*
* **[APK Editor Studio](https://github.com/kefir500/apk-editor-studio) ⭐ 1,657 | 🐛 55 | 🌐 C++ | 📅 2025-01-19** - *Powerful APK editing tool.*
...
* **[XAPK Detector](https://github.com/horsicq/XAPKDetector) ⭐ 692 | 🐛 1 | 🌐 C++ | 📅 2026-09-14** - *Detects and handles XAPK files.*
...
* **[DBI Backend](https://github.com/rashevskyv/dbi) ⭐ 2,942 | 🐛 73 | 🌐 Python | 📅 2026-07-17** - *Nintendo Switch games installer (NSP, NSZ, XCI, XCZ) using DBI (MTP, USB, HTTP).*
...
* **[Switch Theme Injector](https://github.com/exelix11/SwitchThemeInjector) ⭐ 1,237 | 🐛 24 | 🌐 C | 📅 2026-09-11** - *Custom themes creator for Nintendo Switch.*
...
* **[Nand Fix Pro](https://github.com/sthetix/NANDFixPro) ⭐ 124 | 🐛 2 | 🌐 Python | 📅 2026-09-17** - *Nintendo Switch NAND repair tool.*
...
* **[Logisim](https://github.com/logisim-evolution/logisim-evolution) ⭐ 7,591 | 🐛 107 | 🌐 Java | 📅 2026-09-16** - *Educational digital circuit simulator.*
* **[Arduino CLI](https://github.com/arduino/arduino-cli) ⭐ 5,029 | 🐛 269 | 🌐 Go | 📅 2026-09-18** - *Command-line interface for Arduino.*
* **[Fritzing](https://github.com/fritzing/fritzing-app) ⭐ 4,807 | 🐛 496 | 🌐 C++ | 📅 2026-08-12** - *An open-source electronics design software.*
...
* **[DevToys](https://github.com/DevToys-app/DevToys) ⭐ 32,008 | 🐛 340 | 🌐 C# | 📅 2026-02-25** - *A Swiss Army knife for developers.*
* **[Cmder](https://github.com/cmderdev/cmder) ⭐ 27,007 | 🐛 67 | 🌐 PowerShell | 📅 2026-09-14** - *Console emulator.*
* **[Dev-C++](https://github.com/Embarcadero/Dev-Cpp) ⭐ 3,012 | 🐛 214 | 🌐 Pascal | 📅 2024-06-17** - *A fast, portable, simple, and free C/C++ IDE.*
...
* **[Sandboxie](https://github.com/sandboxie-plus/Sandboxie) ⭐ 19,451 | 🐛 755 | 🌐 C | 📅 2026-09-16** - *Enhanced version of the popular sandboxing program.*
* **[Cmake](https://github.com/Kitware/CMake) ⭐ 8,092 | 🐛 2 | 🌐 C | 📅 2026-09-17** - *C, C++ builder.*

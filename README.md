...
* **[Yara](https://github.com/VirusTotal/yara) ⭐ 9,826 | 🐛 170 | 🌐 C | 📅 2026-08-25** - *Malware pattern matching tool.*
* **[Capa](https://github.com/mandiant/capa) ⭐ 6,155 | 🐛 295 | 🌐 Python | 📅 2026-08-24** - *Identify capabilities in executables.*
* **[PE-bear](https://github.com/hasherezade/pe-bear) ⭐ 3,779 | 🐛 15 | 🌐 C++ | 📅 2026-06-10** - *PE reversing tool.*
...
* **[Detect It Easy (DiE)](https://github.com/horsicq/DIE-engine) ⭐ 3,236 | 🐛 14 | 🌐 C++ | 📅 2026-08-25** - *File type identifier.*
...
* **[Driver Store Explorer](https://github.com/lostindark/DriverStoreExplorer) ⭐ 11,496 | 🐛 24 | 🌐 C# | 📅 2026-08-25** - *Driver Store Explorer.*
...
* **[PE-sieve](https://github.com/hasherezade/pe-sieve) ⭐ 3,866 | 🐛 7 | 🌐 C++ | 📅 2026-06-06** - *Scans a given process.*
...
* **[PacketSender](https://github.com/dannagle/PacketSender) ⭐ 2,667 | 🐛 68 | 🌐 C++ | 📅 2026-08-16** - *Send & receive TCP, UDP, SSL, DTLS. HTTP Requests.*
* **[HTTP Toolkit](https://github.com/httptoolkit/httptoolkit-desktop) ⭐ 724 | 🐛 18 | 🌐 TypeScript | 📅 2026-08-21** - *Intercept, view & edit any HTTP traffic.*
...
* **[SQLiteStudio](https://github.com/pawelsalawa/sqlitestudio) ⭐ 6,716 | 🐛 488 | 🌐 C | 📅 2026-08-24** - *SQLite database manager.*
...
* **[GUnPacker](https://github.com/unipacker/unipacker) ⭐ 771 | 🐛 28 | 🌐 Python | 📅 2025-08-18** - *Generic unpacker.*
...
* **[ASPack Unpacker](https://github.com/orcastor/unpack) ⭐ 79 | 🐛 2 | 🌐 Go | 📅 2025-12-21** - *Another ASPack unpacker.*
...
* **[CyberChef](https://github.com/gchq/CyberChef) ⭐ 35,669 | 🐛 556 | 🌐 JavaScript | 📅 2026-08-21** - *Analyzing and decoding data.*
...
* **[UEFITool](https://github.com/LongSoft/UEFITool) ⭐ 5,639 | 🐛 23 | 🌐 C | 📅 2026-07-29** - *UEFI firmware image viewer and editor.*
...
* **[x64dbg](https://github.com/x64dbg/x64dbg) ⭐ 49,293 | 🐛 574 | 🌐 C++ | 📅 2026-08-23** - *Graphical debugger for x86 and x86-64 executables.*
* **[dnSpy](https://github.com/dnSpy/dnSpy) ⚠️ Archived** - *.NET assembly editor, decompiler, and debugger.*
* **[Radare2](https://github.com/radareorg/radare2) ⭐ 24,647 | 🐛 823 | 🌐 C | 📅 2026-08-25** - *A portable and multi-architecture reverse engineering framework.*
* **[Cutter](https://github.com/rizinorg/cutter) ⭐ 19,570 | 🐛 493 | 🌐 C++ | 📅 2026-08-22** - *Free and open-source reverse engineering platform.*
...
* **[Ghidra](https://github.com/NationalSecurityAgency/ghidra) ⭐ 72,797 | 🐛 1,919 | 🌐 Java | 📅 2026-08-25** - *Open-source software reverse engineering suite.*
* **[Capstone](https://github.com/capstone-engine/capstone) ⭐ 8,976 | 🐛 365 | 🌐 C | 📅 2026-08-24** - *Lightweight multi-architecture disassembly framework.*
* **[WABT](https://github.com/WebAssembly/wabt) ⭐ 8,104 | 🐛 228 | 🌐 C++ | 📅 2026-08-25** - *WebAssembly Binary Toolkit - disassembler and tools.*
...
* **[JADX](https://github.com/skylot/jadx) ⭐ 50,210 | 🐛 443 | 🌐 Java | 📅 2026-08-19** - *Dex to Java decompiler.*
* **[ILSpy](https://github.com/icsharpcode/ILSpy) ⭐ 25,946 | 🐛 180 | 🌐 C# | 📅 2026-08-25** - *Open-source .NET assembly browser.*
* **[Bytecode Viewer](https://github.com/Konloch/bytecode-viewer) ⭐ 15,616 | 🐛 103 | 🌐 Java | 📅 2026-07-17** - *Decompile Java/Android bytecode & more.*
* **[JD-GUI](https://github.com/java-decompiler/jd-gui) ⭐ 15,177 | 🐛 248 | 🌐 Java | 📅 2024-07-08** - *Decompile Java class files.*
...
* **[ImHex](https://github.com/WerWolv/ImHex) ⭐ 54,561 | 🐛 391 | 🌐 C++ | 📅 2026-08-25** - *A fast and powerful hex editor.*
...
* **[Frida](https://github.com/frida/frida) ⭐ 21,740 | 🐛 1,959 | 🌐 Meson | 📅 2026-08-18** - *Dynamic instrumentation toolkit.*
* **[Cheat Engine](https://github.com/cheat-engine/cheat-engine) ⭐ 19,051 | 🐛 1,307 | 🌐 Pascal | 📅 2025-04-19** - *Memory scanner/debugger for games and applications.*
...
* **[Exiftool](https://github.com/exiftool/exiftool) ⭐ 4,982 | 🐛 39 | 🌐 Perl | 📅 2026-05-27** - *Meta data editor.*
* **[Far Manager](https://github.com/FarGroup/FarManager) ⭐ 2,212 | 🐛 155 | 🌐 C++ | 📅 2026-08-22** - *Text-based file and archive manager for Windows.*
...
* **[WinSCP](https://github.com/winscp/winscp) ⭐ 3,790 | 🐛 1 | 🌐 C | 📅 2026-08-25** - *Free SFTP, SCP, and FTP client for Windows.*
...
* **[XDELTA Patch Maker](https://github.com/jmacd/xdelta) ⭐ 1,336 | 🐛 108 | 🌐 C | 📅 2026-06-21** - *Patch creator for Inno Setup installers.*
...
* **[OpenMPT](https://github.com/OpenMPT/openmpt) ⭐ 769 | 🐛 3 | 🌐 C++ | 📅 2026-08-19** - *Open-source tracker software.*
...
* **[Nasm](https://github.com/netwide-assembler/nasm) ⭐ 3,287 | 🐛 65 | 🌐 Assembly | 📅 2026-08-19** - *Netwide Assembler for x86 architecture.*
...
* **[ScyllaHide](https://github.com/x64dbg/ScyllaHide) ⭐ 4,269 | 🐛 52 | 🌐 C++ | 📅 2024-06-04** - *Anti-(anti-debugger).*
...
* **[UPX](https://github.com/upx/upx) ⭐ 17,814 | 🐛 23 | 🌐 C++ | 📅 2026-08-25** - *Free, portable, and extendable executable packer.*
...
* **[Etcher](https://github.com/balena-io/etcher) ⭐ 34,228 | 🐛 687 | 🌐 TypeScript | 📅 2026-06-02** - *A cross-platform tool to flash OS images onto SD cards and USB.*
* **[OTP Extractor](https://github.com/scito/extract_otp_secrets) ⭐ 1,645 | 🐛 5 | 🌐 Python | 📅 2026-08-25** - *Tool for extracting OTPs (One-Time Passwords).*
...
* **[Apktool](https://github.com/iBotPeaches/Apktool) ⭐ 25,376 | 🐛 82 | 🌐 Java | 📅 2026-08-25** - *Tool for decompiling and recompiling Android APK files.*
* **[APK Editor Studio](https://github.com/kefir500/apk-editor-studio) ⭐ 1,647 | 🐛 55 | 🌐 C++ | 📅 2025-01-19** - *Powerful APK editing tool.*
* **[Bifrost](https://github.com/zacharee/Bifrost) ⭐ 1,558 | 🐛 4 | 🌐 Kotlin | 📅 2026-08-24** - *Tool for downloading Samsung mobile device firmware.*
...
* **[DBI Backend](https://github.com/rashevskyv/dbi) ⭐ 2,922 | 🐛 73 | 🌐 Python | 📅 2026-07-17** - *Nintendo Switch games installer (NSP, NSZ, XCI, XCZ) using DBI (MTP, USB, HTTP).*
* **[NS-USBloader](https://github.com/developersu/ns-usbloader) ⭐ 2,317 | 🐛 53 | 🌐 Java | 📅 2026-08-20** - *Nintendo Switch games installer using Awoo-Installer.*
...
* **[Appstore](https://github.com/fortheusers/hb-appstore) ⭐ 1,441 | 🐛 26 | 🌐 C++ | 📅 2026-07-08** - *GUI Homebrew app store for CFW.*
...
* **[Logisim](https://github.com/logisim-evolution/logisim-evolution) ⭐ 7,481 | 🐛 133 | 🌐 Java | 📅 2026-08-25** - *Educational digital circuit simulator.*
...
* **[DevToys](https://github.com/DevToys-app/DevToys) ⭐ 31,899 | 🐛 338 | 🌐 C# | 📅 2026-02-25** - *A Swiss Army knife for developers.*
...
* **[Sandboxie](https://github.com/sandboxie-plus/Sandboxie) ⭐ 19,248 | 🐛 746 | 🌐 C | 📅 2026-08-25** - *Enhanced version of the popular sandboxing program.*

...
* **[Capa](https://github.com/mandiant/capa) ⭐ 6,141 | 🐛 291 | 🌐 Python | 📅 2026-08-17** - *Identify capabilities in executables.*
* **[PE-bear](https://github.com/hasherezade/pe-bear) ⭐ 3,769 | 🐛 15 | 🌐 C++ | 📅 2026-06-10** - *PE reversing tool.*
...
* **[Detect It Easy (DiE)](https://github.com/horsicq/DIE-engine) ⭐ 3,227 | 🐛 13 | 🌐 C++ | 📅 2026-08-16** - *File type identifier.*
...
* **[Driver Store Explorer](https://github.com/lostindark/DriverStoreExplorer) ⭐ 11,441 | 🐛 24 | 🌐 C# | 📅 2026-08-09** - *Driver Store Explorer.*
...
* **[Papercut](https://github.com/ChangemakerStudios/Papercut) ⭐ 3,325 | 🐛 3 | 🌐 C# | 📅 2026-08-17** - *Simple SMTP server for testing.*
...
* **[SQLiteStudio](https://github.com/pawelsalawa/sqlitestudio) ⭐ 6,708 | 🐛 489 | 🌐 C | 📅 2026-08-14** - *SQLite database manager.*
* **[GrepWin (Text)](https://github.com/stefankueng/grepWin) ⭐ 2,059 | 🐛 46 | 🌐 C++ | 📅 2026-06-03** - *Search tool for Windows.*
* **[XMachO Viewer](https://github.com/horsicq/XMachOViewer) ⭐ 960 | 🐛 4 | 🌐 C++ | 📅 2026-08-17** - *Mac OS XMachO Viewer.*
...
* **[CyberChef](https://github.com/gchq/CyberChef) ⭐ 35,604 | 🐛 564 | 🌐 JavaScript | 📅 2026-08-17** - *Analyzing and decoding data.*
...
* **[UEFITool](https://github.com/LongSoft/UEFITool) ⭐ 5,627 | 🐛 23 | 🌐 C | 📅 2026-07-29** - *UEFI firmware image viewer and editor.*
...
* **[x64dbg](https://github.com/x64dbg/x64dbg) ⭐ 49,181 | 🐛 573 | 🌐 C++ | 📅 2026-08-15** - *Graphical debugger for x86 and x86-64 executables.*
* **[dnSpy](https://github.com/dnSpy/dnSpy) ⚠️ Archived** - *.NET assembly editor, decompiler, and debugger.*
* **[Radare2](https://github.com/radareorg/radare2) ⭐ 24,587 | 🐛 820 | 🌐 C | 📅 2026-08-17** - *A portable and multi-architecture reverse engineering framework.*
* **[Cutter](https://github.com/rizinorg/cutter) ⭐ 19,471 | 🐛 492 | 🌐 C++ | 📅 2026-08-13** - *Free and open-source reverse engineering platform.*
...
* **[Ghidra](https://github.com/NationalSecurityAgency/ghidra) ⭐ 72,448 | 🐛 1,915 | 🌐 Java | 📅 2026-08-17** - *Open-source software reverse engineering suite.*
...
* **[WABT](https://github.com/WebAssembly/wabt) ⭐ 8,100 | 🐛 230 | 🌐 C++ | 📅 2026-08-17** - *WebAssembly Binary Toolkit - disassembler and tools.*
...
* **[JADX](https://github.com/skylot/jadx) ⭐ 50,103 | 🐛 443 | 🌐 Java | 📅 2026-08-05** - *Dex to Java decompiler.*
* **[ILSpy](https://github.com/icsharpcode/ILSpy) ⭐ 25,872 | 🐛 188 | 🌐 C# | 📅 2026-08-17** - *Open-source .NET assembly browser.*
...
* **[FFDec](https://github.com/jindrapetrik/jpexs-decompiler) ⭐ 5,808 | 🐛 5 | 🌐 Java | 📅 2026-08-08** - *Flash Decompiler.*
...
* **[ImHex](https://github.com/WerWolv/ImHex) ⭐ 54,487 | 🐛 385 | 🌐 C++ | 📅 2026-08-17** - *A fast and powerful hex editor.*
...
* **[Frida](https://github.com/frida/frida) ⭐ 21,650 | 🐛 1,956 | 🌐 Meson | 📅 2026-08-17** - *Dynamic instrumentation toolkit.*
* **[Cheat Engine](https://github.com/cheat-engine/cheat-engine) ⭐ 18,987 | 🐛 1,307 | 🌐 Pascal | 📅 2025-04-19** - *Memory scanner/debugger for games and applications.*
...
* **[XPEViewer](https://github.com/horsicq/XPEViewer) ⭐ 1,226 | 🐛 5 | 🌐 QMake | 📅 2026-08-17** - *Executable file viewer and editor.*
...
* **[Exiftool](https://github.com/exiftool/exiftool) ⭐ 4,957 | 🐛 38 | 🌐 Perl | 📅 2026-05-27** - *Meta data editor.*
...
* **[WinSCP](https://github.com/winscp/winscp) ⭐ 3,773 | 🐛 1 | 🌐 C | 📅 2026-08-16** - *Free SFTP, SCP, and FTP client for Windows.*
...
* **[XDELTA Patch Maker](https://github.com/jmacd/xdelta) ⭐ 1,333 | 🐛 108 | 🌐 C | 📅 2026-06-21** - *Patch creator for Inno Setup installers.*
...
* **[OpenMPT](https://github.com/OpenMPT/openmpt) ⭐ 764 | 🐛 3 | 🌐 C++ | 📅 2026-08-17** - *Open-source tracker software.*
...
* **[Nasm](https://github.com/netwide-assembler/nasm) ⭐ 3,278 | 🐛 61 | 🌐 Assembly | 📅 2026-07-07** - *Netwide Assembler for x86 architecture.*
* **AsmEdit** - *ASM Editor.*
...
* **[UPX](https://github.com/upx/upx) ⭐ 17,786 | 🐛 27 | 🌐 C++ | 📅 2026-08-17** - *Free, portable, and extendable executable packer.*
...
* **[Etcher](https://github.com/balena-io/etcher) ⭐ 34,178 | 🐛 685 | 🌐 TypeScript | 📅 2026-06-02** - *A cross-platform tool to flash OS images onto SD cards and USB.*
* **[OTP Extractor](https://github.com/scito/extract_otp_secrets) ⭐ 1,645 | 🐛 3 | 🌐 Python | 📅 2026-08-16** - *Tool for extracting OTPs (One-Time Passwords).*
...
* **[Apktool](https://github.com/iBotPeaches/Apktool) ⭐ 25,307 | 🐛 77 | 🌐 Java | 📅 2026-08-11** - *Tool for decompiling and recompiling Android APK files.*
...
* **[DBI Backend](https://github.com/rashevskyv/dbi) ⭐ 2,916 | 🐛 73 | 🌐 Python | 📅 2026-07-17** - *Nintendo Switch games installer (NSP, NSZ, XCI, XCZ) using DBI (MTP, USB, HTTP).*
* **[NS-USBloader](https://github.com/developersu/ns-usbloader) ⭐ 2,314 | 🐛 54 | 🌐 Java | 📅 2026-08-16** - *Nintendo Switch games installer using Awoo-Installer.*
...
* **[Appstore](https://github.com/fortheusers/hb-appstore) ⭐ 1,436 | 🐛 26 | 🌐 C++ | 📅 2026-07-08** - *GUI Homebrew app store for CFW.*
...
* **[Switch Theme Injector](https://github.com/exelix11/SwitchThemeInjector) ⭐ 1,231 | 🐛 24 | 🌐 C | 📅 2026-08-17** - *Custom themes creator for Nintendo Switch.*
...
* **[Logisim](https://github.com/logisim-evolution/logisim-evolution) ⭐ 7,442 | 🐛 153 | 🌐 Java | 📅 2026-08-17** - *Educational digital circuit simulator.*
* **[Arduino CLI](https://github.com/arduino/arduino-cli) ⭐ 4,992 | 🐛 262 | 🌐 Go | 📅 2026-08-17** - *Command-line interface for Arduino.*
* **[Fritzing](https://github.com/fritzing/fritzing-app) ⭐ 4,771 | 🐛 490 | 🌐 C++ | 📅 2026-08-12** - *An open-source electronics design software.*
...
* **[Cmder](https://github.com/cmderdev/cmder) ⭐ 26,990 | 🐛 67 | 🌐 PowerShell | 📅 2026-08-17** - *Console emulator.*
...
* **[Sandboxie](https://github.com/sandboxie-plus/Sandboxie) ⭐ 19,172 | 🐛 727 | 🌐 C | 📅 2026-08-17** - *Enhanced version of the popular sandboxing program.*
* **[Cmake](https://github.com/Kitware/CMake) ⭐ 8,034 | 🐛 2 | 🌐 C | 📅 2026-08-17** - *C, C++ builder.*
* **[Npcap](https://github.com/nmap/npcap) ⭐ 3,574 | 🐛 241 | 🌐 C | 📅 2026-05-28** - *Packet capture library installer.*
* **[MSYS2](https://github.com/nmap/npcap) ⭐ 3,574 | 🐛 241 | 🌐 C | 📅 2026-05-28** - *Unix SDK installer for Windows.*

...
* **[Yara](https://github.com/VirusTotal/yara) ⭐ 9,879 | 🐛 172 | 🌐 C | 📅 2026-08-25** - *Malware pattern matching tool.*
...
* **[Driver Store Explorer](https://github.com/lostindark/DriverStoreExplorer) ⭐ 11,692 | 🐛 25 | 🌐 C# | 📅 2026-09-16** - *Driver Store Explorer.*
...
* **[PE-sieve](https://github.com/hasherezade/pe-sieve) ⭐ 3,898 | 🐛 7 | 🌐 C++ | 📅 2026-06-06** - *Scans a given process.*
...
* **[GrepWin (Text)](https://github.com/stefankueng/grepWin) ⭐ 2,073 | 🐛 49 | 🌐 C++ | 📅 2026-09-19** - *Search tool for Windows.*
* **[XMachO Viewer](https://github.com/horsicq/XMachOViewer) ⭐ 963 | 🐛 4 | 🌐 C++ | 📅 2026-09-19** - *Mac OS XMachO Viewer.*
...
* **[CyberChef](https://github.com/gchq/CyberChef) ⭐ 35,886 | 🐛 590 | 🌐 JavaScript | 📅 2026-09-19** - *Analyzing and decoding data.*
...
* **[UEFITool](https://github.com/LongSoft/UEFITool) ⭐ 5,681 | 🐛 23 | 🌐 C | 📅 2026-07-29** - *UEFI firmware image viewer and editor.*
* **[UniExtract](https://github.com/Bioruebe/UniExtract2) ⭐ 4,425 | 🐛 123 | 🌐 AutoIt | 📅 2024-07-06** - *Universal archive extractor.*
...
* **[RegRipper](https://github.com/keydet89/RegRipper3.0) ⭐ 719 | 🐛 9 | 🌐 Perl | 📅 2026-05-27** - *Another registry extractor.*
...
* **[x64dbg](https://github.com/x64dbg/x64dbg) ⭐ 49,557 | 🐛 572 | 🌐 C++ | 📅 2026-09-19** - *Graphical debugger for x86 and x86-64 executables.*
* **[dnSpy](https://github.com/dnSpy/dnSpy) ⚠️ Archived** - *.NET assembly editor, decompiler, and debugger.*
* **[Radare2](https://github.com/radareorg/radare2) ⭐ 24,831 | 🐛 833 | 🌐 C | 📅 2026-09-20** - *A portable and multi-architecture reverse engineering framework.*
* **[Cutter](https://github.com/rizinorg/cutter) ⭐ 19,746 | 🐛 494 | 🌐 C++ | 📅 2026-09-11** - *Free and open-source reverse engineering platform.*
...
* **[Ghidra](https://github.com/NationalSecurityAgency/ghidra) ⭐ 79,048 | 🐛 1,963 | 🌐 Java | 📅 2026-09-18** - *Open-source software reverse engineering suite.*
* **[Capstone](https://github.com/capstone-engine/capstone) ⭐ 9,031 | 🐛 355 | 🌐 C | 📅 2026-09-19** - *Lightweight multi-architecture disassembly framework.*
* **[WABT](https://github.com/WebAssembly/wabt) ⭐ 8,134 | 🐛 233 | 🌐 C++ | 📅 2026-09-18** - *WebAssembly Binary Toolkit - disassembler and tools.*
...
* **[JADX](https://github.com/skylot/jadx) ⭐ 50,524 | 🐛 449 | 🌐 Java | 📅 2026-09-12** - *Dex to Java decompiler.*
* **[ILSpy](https://github.com/icsharpcode/ILSpy) ⭐ 26,099 | 🐛 178 | 🌐 C# | 📅 2026-09-19** - *Open-source .NET assembly browser.*
* **[Bytecode Viewer](https://github.com/Konloch/bytecode-viewer) ⭐ 15,649 | 🐛 103 | 🌐 Java | 📅 2026-07-17** - *Decompile Java/Android bytecode & more.*
* **[JD-GUI](https://github.com/java-decompiler/jd-gui) ⭐ 15,198 | 🐛 248 | 🌐 Java | 📅 2024-07-08** - *Decompile Java class files.*
* **[FFDec](https://github.com/jindrapetrik/jpexs-decompiler) ⭐ 5,878 | 🐛 2 | 🌐 Java | 📅 2026-09-19** - *Flash Decompiler.*
...
* **[ImHex](https://github.com/WerWolv/ImHex) ⭐ 54,841 | 🐛 402 | 🌐 C++ | 📅 2026-09-18** - *A fast and powerful hex editor.*
...
* **[Frida](https://github.com/frida/frida) ⭐ 21,976 | 🐛 1,964 | 🌐 Meson | 📅 2026-09-16** - *Dynamic instrumentation toolkit.*
* **[Cheat Engine](https://github.com/cheat-engine/cheat-engine) ⭐ 19,186 | 🐛 1,310 | 🌐 Pascal | 📅 2025-04-19** - *Memory scanner/debugger for games and applications.*
* **[ReClass.NET](https://github.com/ReClassNET/ReClass.NET) ⭐ 2,205 | 🐛 84 | 🌐 C# | 📅 2024-05-10** - *.Net structure class reverser.*
* **[XELFViewer](https://github.com/horsicq/XELFViewer) ⭐ 1,584 | 🐛 8 | 🌐 C++ | 📅 2026-09-19** - *ELF files viewer and editor.*
* **[Scylla](https://github.com/NtQuery/Scylla) ⭐ 1,434 | 🐛 23 | 🌐 C++ | 📅 2023-04-05** - *Powerful and advanced x86/x86-64 executable unpacker.*
* **[XPEViewer](https://github.com/horsicq/XPEViewer) ⭐ 1,234 | 🐛 5 | 🌐 QMake | 📅 2026-09-19** - *Executable file viewer and editor.*
...
* **[Exiftool](https://github.com/exiftool/exiftool) ⭐ 5,067 | 🐛 43 | 🌐 Perl | 📅 2026-05-27** - *Meta data editor.*
...
* **[XDELTA Patch Maker](https://github.com/jmacd/xdelta) ⭐ 1,354 | 🐛 107 | 🌐 C | 📅 2026-09-06** - *Patch creator for Inno Setup installers.*
...
* **[UPX](https://github.com/upx/upx) ⭐ 17,883 | 🐛 21 | 🌐 C++ | 📅 2026-09-18** - *Free, portable, and extendable executable packer.*
...
* **[Etcher](https://github.com/balena-io/etcher) ⭐ 34,374 | 🐛 693 | 🌐 TypeScript | 📅 2026-09-18** - *A cross-platform tool to flash OS images onto SD cards and USB.*
...
* **[Apktool](https://github.com/iBotPeaches/Apktool) ⭐ 25,609 | 🐛 77 | 🌐 Java | 📅 2026-09-19** - *Tool for decompiling and recompiling Android APK files.*
...
* **[Quark](https://github.com/XorTroll/Goldleaf) ⭐ 3,040 | 🐛 89 | 🌐 C | 📅 2026-09-06** - *Nintendo Switch games installer using Goldleaf.*
* **[DBI Backend](https://github.com/rashevskyv/dbi) ⭐ 2,946 | 🐛 73 | 🌐 Python | 📅 2026-09-18** - *Nintendo Switch games installer (NSP, NSZ, XCI, XCZ) using DBI (MTP, USB, HTTP).*
* **[NS-USBloader](https://github.com/developersu/ns-usbloader) ⭐ 2,329 | 🐛 50 | 🌐 Java | 📅 2026-09-19** - *Nintendo Switch games installer using Awoo-Installer.*
* **[TegraRcmGUI](https://github.com/eliboa/TegraRcmGUI) ⭐ 2,304 | 🐛 24 | 🌐 C++ | 📅 2021-11-30** - *Nintendo Switch payload injector (RCM Mode).*
...
* **[Switch Theme Injector](https://github.com/exelix11/SwitchThemeInjector) ⭐ 1,239 | 🐛 25 | 🌐 C | 📅 2026-09-11** - *Custom themes creator for Nintendo Switch.*
* **[Joy-Con Toolkit](https://github.com/CTCaer/jc_toolkit) ⭐ 1,105 | 🐛 77 | 🌐 C++ | 📅 2024-05-07** - *Nintendo Switch Joy-Con toolkit.*
* **[NX Nand Manager](https://github.com/eliboa/NxNandManager) ⭐ 976 | 🐛 50 | 🌐 C++ | 📅 2026-09-11** - *Nintendo Switch NAND manager.*
...
* **[Logisim](https://github.com/logisim-evolution/logisim-evolution) ⭐ 7,604 | 🐛 109 | 🌐 Java | 📅 2026-09-19** - *Educational digital circuit simulator.*
* **[Arduino CLI](https://github.com/arduino/arduino-cli) ⭐ 5,033 | 🐛 269 | 🌐 Go | 📅 2026-09-18** - *Command-line interface for Arduino.*
...
* **[DevToys](https://github.com/DevToys-app/DevToys) ⭐ 32,016 | 🐛 340 | 🌐 C# | 📅 2026-02-25** - *A Swiss Army knife for developers.*
...
* **[Sandboxie](https://github.com/sandboxie-plus/Sandboxie) ⭐ 19,480 | 🐛 751 | 🌐 C | 📅 2026-09-19** - *Enhanced version of the popular sandboxing program.*
* **[Cmake](https://github.com/Kitware/CMake) ⭐ 8,098 | 🐛 2 | 🌐 C | 📅 2026-09-19** - *C, C++ builder.*
* **[Npcap](https://github.com/nmap/npcap) ⭐ 3,602 | 🐛 246 | 🌐 C | 📅 2026-09-12** - *Packet capture library installer.*
* **[MSYS2](https://github.com/nmap/npcap) ⭐ 3,602 | 🐛 246 | 🌐 C | 📅 2026-09-12** - *Unix SDK installer for Windows.*

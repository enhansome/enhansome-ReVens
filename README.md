...
* Download latest ReVens from: [Releases](https://github.com/Jakiboy/ReVens/releases) ⭐ 355 | 🐛 0 | 🌐 JavaScript | 📅 2026-05-23.
...
* **[Yara](https://github.com/VirusTotal/yara) ⭐ 9,856 | 🐛 169 | 🌐 C | 📅 2026-08-25** - *Malware pattern matching tool.*
* **[Capa](https://github.com/mandiant/capa) ⭐ 6,176 | 🐛 298 | 🌐 Python | 📅 2026-09-08** - *Identify capabilities in executables.*
* **[PE-bear](https://github.com/hasherezade/pe-bear) ⭐ 3,797 | 🐛 17 | 🌐 C++ | 📅 2026-06-10** - *PE reversing tool.*
...
* **[Detect It Easy (DiE)](https://github.com/horsicq/DIE-engine) ⭐ 3,259 | 🐛 13 | 🌐 C++ | 📅 2026-09-07** - *File type identifier.*
...
* **[Driver Store Explorer](https://github.com/lostindark/DriverStoreExplorer) ⭐ 11,583 | 🐛 23 | 🌐 C# | 📅 2026-09-08** - *Driver Store Explorer.*
...
* **[PE-sieve](https://github.com/hasherezade/pe-sieve) ⭐ 3,886 | 🐛 7 | 🌐 C++ | 📅 2026-06-06** - *Scans a given process.*
...
* **[XMachO Viewer](https://github.com/horsicq/XMachOViewer) ⭐ 961 | 🐛 4 | 🌐 C++ | 📅 2026-09-08** - *Mac OS XMachO Viewer.*
...
* **[Magicmida](https://github.com/Hendi48/Magicmida) ⭐ 706 | 🐛 18 | 🌐 Pascal | 📅 2026-05-14** - *Themida/WinLicense unpacker.*
...
* **[CyberChef](https://github.com/gchq/CyberChef) ⭐ 35,779 | 🐛 563 | 🌐 JavaScript | 📅 2026-09-07** - *Analyzing and decoding data.*
...
* **[UEFITool](https://github.com/LongSoft/UEFITool) ⭐ 5,662 | 🐛 23 | 🌐 C | 📅 2026-07-29** - *UEFI firmware image viewer and editor.*
...
* **[x64dbg](https://github.com/x64dbg/x64dbg) ⭐ 49,453 | 🐛 581 | 🌐 C++ | 📅 2026-09-08** - *Graphical debugger for x86 and x86-64 executables.*
* **[dnSpy](https://github.com/dnSpy/dnSpy) ⚠️ Archived** - *.NET assembly editor, decompiler, and debugger.*
* **[Radare2](https://github.com/radareorg/radare2) ⭐ 24,762 | 🐛 821 | 🌐 C | 📅 2026-09-08** - *A portable and multi-architecture reverse engineering framework.*
* **[Cutter](https://github.com/rizinorg/cutter) ⭐ 19,699 | 🐛 493 | 🌐 C++ | 📅 2026-08-22** - *Free and open-source reverse engineering platform.*
...
* **[Ghidra](https://github.com/NationalSecurityAgency/ghidra) ⭐ 74,624 | 🐛 1,944 | 🌐 Java | 📅 2026-09-08** - *Open-source software reverse engineering suite.*
* **[Capstone](https://github.com/capstone-engine/capstone) ⭐ 9,003 | 🐛 357 | 🌐 C | 📅 2026-09-08** - *Lightweight multi-architecture disassembly framework.*
* **[WABT](https://github.com/WebAssembly/wabt) ⭐ 8,123 | 🐛 238 | 🌐 C++ | 📅 2026-09-06** - *WebAssembly Binary Toolkit - disassembler and tools.*
...
* **[JADX](https://github.com/skylot/jadx) ⭐ 50,382 | 🐛 446 | 🌐 Java | 📅 2026-09-08** - *Dex to Java decompiler.*
* **[ILSpy](https://github.com/icsharpcode/ILSpy) ⭐ 26,033 | 🐛 174 | 🌐 C# | 📅 2026-09-08** - *Open-source .NET assembly browser.*
* **[Bytecode Viewer](https://github.com/Konloch/bytecode-viewer) ⭐ 15,635 | 🐛 103 | 🌐 Java | 📅 2026-07-17** - *Decompile Java/Android bytecode & more.*
...
* **[ImHex](https://github.com/WerWolv/ImHex) ⭐ 54,754 | 🐛 401 | 🌐 C++ | 📅 2026-09-08** - *A fast and powerful hex editor.*
...
* **[Frida](https://github.com/frida/frida) ⭐ 21,868 | 🐛 1,962 | 🌐 Meson | 📅 2026-09-08** - *Dynamic instrumentation toolkit.*
* **[Cheat Engine](https://github.com/cheat-engine/cheat-engine) ⭐ 19,149 | 🐛 1,307 | 🌐 Pascal | 📅 2025-04-19** - *Memory scanner/debugger for games and applications.*
* **[ReClass.NET](https://github.com/ReClassNET/ReClass.NET) ⭐ 2,197 | 🐛 84 | 🌐 C# | 📅 2024-05-10** - *.Net structure class reverser.*
* **[XELFViewer](https://github.com/horsicq/XELFViewer) ⭐ 1,583 | 🐛 8 | 🌐 C++ | 📅 2026-09-08** - *ELF files viewer and editor.*
* **[Scylla](https://github.com/NtQuery/Scylla) ⭐ 1,425 | 🐛 23 | 🌐 C++ | 📅 2023-04-05** - *Powerful and advanced x86/x86-64 executable unpacker.*
* **[XPEViewer](https://github.com/horsicq/XPEViewer) ⭐ 1,232 | 🐛 5 | 🌐 QMake | 📅 2026-09-08** - *Executable file viewer and editor.*
...
* **[Exiftool](https://github.com/exiftool/exiftool) ⭐ 5,017 | 🐛 42 | 🌐 Perl | 📅 2026-05-27** - *Meta data editor.*
* **[Far Manager](https://github.com/FarGroup/FarManager) ⭐ 2,223 | 🐛 157 | 🌐 C++ | 📅 2026-09-06** - *Text-based file and archive manager for Windows.*
...
* **[WinSCP](https://github.com/winscp/winscp) ⭐ 3,824 | 🐛 1 | 🌐 C | 📅 2026-09-08** - *Free SFTP, SCP, and FTP client for Windows.*
...
* **[XDELTA Patch Maker](https://github.com/jmacd/xdelta) ⭐ 1,343 | 🐛 107 | 🌐 C | 📅 2026-09-06** - *Patch creator for Inno Setup installers.*
...
* **[Nasm](https://github.com/netwide-assembler/nasm) ⭐ 3,314 | 🐛 70 | 🌐 Assembly | 📅 2026-08-19** - *Netwide Assembler for x86 architecture.*
...
* **[ScyllaHide](https://github.com/x64dbg/ScyllaHide) ⭐ 4,289 | 🐛 53 | 🌐 C++ | 📅 2024-06-04** - *Anti-(anti-debugger).*
...
* **[ProGuard](https://github.com/Guardsquare/proguard) ⭐ 3,652 | 🐛 176 | 🌐 Java | 📅 2026-08-24** - *Java optimizer and obfuscator.*
...
* **[UPX](https://github.com/upx/upx) ⭐ 17,857 | 🐛 24 | 🌐 C++ | 📅 2026-09-08** - *Free, portable, and extendable executable packer.*
...
* **[Etcher](https://github.com/balena-io/etcher) ⭐ 34,316 | 🐛 690 | 🌐 TypeScript | 📅 2026-06-02** - *A cross-platform tool to flash OS images onto SD cards and USB.*
* **[OTP Extractor](https://github.com/scito/extract_otp_secrets) ⭐ 1,654 | 🐛 5 | 🌐 Python | 📅 2026-09-08** - *Tool for extracting OTPs (One-Time Passwords).*
...
* **[Apktool](https://github.com/iBotPeaches/Apktool) ⭐ 25,503 | 🐛 77 | 🌐 Java | 📅 2026-09-04** - *Tool for decompiling and recompiling Android APK files.*
* **[APK Editor Studio](https://github.com/kefir500/apk-editor-studio) ⭐ 1,649 | 🐛 55 | 🌐 C++ | 📅 2025-01-19** - *Powerful APK editing tool.*
* **[Bifrost](https://github.com/zacharee/Bifrost) ⭐ 1,590 | 🐛 3 | 🌐 Kotlin | 📅 2026-09-05** - *Tool for downloading Samsung mobile device firmware.*
...
* **[NXDT Host](https://github.com/DarkMatterCore/nxdumptool) ⭐ 1,290 | 🐛 20 | 🌐 C | 📅 2026-08-04** - *Nintendo Switch dump tool server.*
...
* **[Logisim](https://github.com/logisim-evolution/logisim-evolution) ⭐ 7,541 | 🐛 104 | 🌐 Java | 📅 2026-09-08** - *Educational digital circuit simulator.*
* **[Arduino CLI](https://github.com/arduino/arduino-cli) ⭐ 5,020 | 🐛 266 | 🌐 Go | 📅 2026-09-08** - *Command-line interface for Arduino.*
* **[Fritzing](https://github.com/fritzing/fritzing-app) ⭐ 4,802 | 🐛 496 | 🌐 C++ | 📅 2026-08-12** - *An open-source electronics design software.*
...
* **[DevToys](https://github.com/DevToys-app/DevToys) ⭐ 31,964 | 🐛 341 | 🌐 C# | 📅 2026-02-25** - *A Swiss Army knife for developers.*
* **[Cmder](https://github.com/cmderdev/cmder) ⭐ 27,002 | 🐛 67 | 🌐 PowerShell | 📅 2026-08-31** - *Console emulator.*
* **[Dev-C++](https://github.com/Embarcadero/Dev-Cpp) ⭐ 3,001 | 🐛 214 | 🌐 Pascal | 📅 2024-06-17** - *A fast, portable, simple, and free C/C++ IDE.*
...
* **[Sandboxie](https://github.com/sandboxie-plus/Sandboxie) ⭐ 19,377 | 🐛 746 | 🌐 C | 📅 2026-09-06** - *Enhanced version of the popular sandboxing program.*
* **[Cmake](https://github.com/Kitware/CMake) ⭐ 8,061 | 🐛 2 | 🌐 C | 📅 2026-09-08** - *C, C++ builder.*
* **[Npcap](https://github.com/nmap/npcap) ⭐ 3,589 | 🐛 245 | 🌐 C | 📅 2026-05-28** - *Packet capture library installer.*
* **[MSYS2](https://github.com/nmap/npcap) ⭐ 3,589 | 🐛 245 | 🌐 C | 📅 2026-05-28** - *Unix SDK installer for Windows.*

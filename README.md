...
* **[Yara](https://github.com/VirusTotal/yara) ⭐ 9,808 | 🐛 177 | 🌐 C | 📅 2026-07-30** - *Malware pattern matching tool.*
* **[Capa](https://github.com/mandiant/capa) ⭐ 6,135 | 🐛 287 | 🌐 Python | 📅 2026-08-14** - *Identify capabilities in executables.*
* **[PE-bear](https://github.com/hasherezade/pe-bear) ⭐ 3,765 | 🐛 15 | 🌐 C++ | 📅 2026-06-10** - *PE reversing tool.*
...
* **[Detect It Easy (DiE)](https://github.com/horsicq/DIE-engine) ⭐ 3,222 | 🐛 13 | 🌐 C++ | 📅 2026-08-14** - *File type identifier.*
...
* **[Exeinfo PE (ASL)](https://github.com/ExeinfoASL/ASL) ⭐ 1,133 | 🐛 8 | 📅 2026-08-08** - *Detects packers and compressors.*
...
* **[Driver Store Explorer](https://github.com/lostindark/DriverStoreExplorer) ⭐ 11,400 | 🐛 24 | 🌐 C# | 📅 2026-08-09** - *Driver Store Explorer.*
...
* **[SQLiteStudio](https://github.com/pawelsalawa/sqlitestudio) ⭐ 6,703 | 🐛 487 | 🌐 C | 📅 2026-08-14** - *SQLite database manager.*
* **[GrepWin (Text)](https://github.com/stefankueng/grepWin) ⭐ 2,061 | 🐛 46 | 🌐 C++ | 📅 2026-06-03** - *Search tool for Windows.*
* **[XMachO Viewer](https://github.com/horsicq/XMachOViewer) ⭐ 958 | 🐛 4 | 🌐 C++ | 📅 2026-08-14** - *Mac OS XMachO Viewer.*
...
* **[Magicmida](https://github.com/Hendi48/Magicmida) ⭐ 691 | 🐛 16 | 🌐 Pascal | 📅 2026-05-14** - *Themida/WinLicense unpacker.*
...
* **[CyberChef](https://github.com/gchq/CyberChef) ⭐ 35,582 | 🐛 564 | 🌐 JavaScript | 📅 2026-08-14** - *Analyzing and decoding data.*
...
* **[x64dbg](https://github.com/x64dbg/x64dbg) ⭐ 49,161 | 🐛 577 | 🌐 C++ | 📅 2026-08-09** - *Graphical debugger for x86 and x86-64 executables.*
* **[dnSpy](https://github.com/dnSpy/dnSpy) ⚠️ Archived** - *.NET assembly editor, decompiler, and debugger.*
* **[Radare2](https://github.com/radareorg/radare2) ⭐ 24,568 | 🐛 820 | 🌐 C | 📅 2026-08-14** - *A portable and multi-architecture reverse engineering framework.*
* **[Cutter](https://github.com/rizinorg/cutter) ⭐ 19,464 | 🐛 491 | 🌐 C++ | 📅 2026-08-13** - *Free and open-source reverse engineering platform.*
...
* **[Ghidra](https://github.com/NationalSecurityAgency/ghidra) ⭐ 72,376 | 🐛 1,908 | 🌐 Java | 📅 2026-08-13** - *Open-source software reverse engineering suite.*
* **[Capstone](https://github.com/capstone-engine/capstone) ⭐ 8,949 | 🐛 360 | 🌐 C | 📅 2026-08-13** - *Lightweight multi-architecture disassembly framework.*
...
* **[JADX](https://github.com/skylot/jadx) ⭐ 50,064 | 🐛 443 | 🌐 Java | 📅 2026-08-05** - *Dex to Java decompiler.*
* **[ILSpy](https://github.com/icsharpcode/ILSpy) ⭐ 25,852 | 🐛 194 | 🌐 C# | 📅 2026-08-14** - *Open-source .NET assembly browser.*
* **[Bytecode Viewer](https://github.com/Konloch/bytecode-viewer) ⭐ 15,595 | 🐛 103 | 🌐 Java | 📅 2026-07-17** - *Decompile Java/Android bytecode & more.*
* **[JD-GUI](https://github.com/java-decompiler/jd-gui) ⭐ 15,173 | 🐛 248 | 🌐 Java | 📅 2024-07-08** - *Decompile Java class files.*
* **[FFDec](https://github.com/jindrapetrik/jpexs-decompiler) ⭐ 5,797 | 🐛 5 | 🌐 Java | 📅 2026-08-08** - *Flash Decompiler.*
...
* **[ImHex](https://github.com/WerWolv/ImHex) ⭐ 54,460 | 🐛 386 | 🌐 C++ | 📅 2026-08-14** - *A fast and powerful hex editor.*
...
* **[Frida](https://github.com/frida/frida) ⭐ 21,626 | 🐛 1,956 | 🌐 Meson | 📅 2026-08-13** - *Dynamic instrumentation toolkit.*
* **[Cheat Engine](https://github.com/cheat-engine/cheat-engine) ⭐ 18,959 | 🐛 1,306 | 🌐 Pascal | 📅 2025-04-19** - *Memory scanner/debugger for games and applications.*
* **[ReClass.NET](https://github.com/ReClassNET/ReClass.NET) ⭐ 2,182 | 🐛 84 | 🌐 C# | 📅 2024-05-10** - *.Net structure class reverser.*
* **[XELFViewer](https://github.com/horsicq/XELFViewer) ⭐ 1,581 | 🐛 8 | 🌐 C++ | 📅 2026-08-01** - *ELF files viewer and editor.*
* **[Scylla](https://github.com/NtQuery/Scylla) ⭐ 1,415 | 🐛 23 | 🌐 C++ | 📅 2023-04-05** - *Powerful and advanced x86/x86-64 executable unpacker.*
* **[XPEViewer](https://github.com/horsicq/XPEViewer) ⭐ 1,228 | 🐛 5 | 🌐 QMake | 📅 2026-08-14** - *Executable file viewer and editor.*
* **[PE Tools](https://github.com/petoolse/petools) ⭐ 1,195 | 🐛 10 | 📅 2025-10-21** - *PE manipulation toolkit.*
* **[KDiff3](https://github.com/KDE/kdiff3) ⭐ 610 | 🐛 0 | 🌐 C++ | 📅 2026-08-14** - *File and directory diff and merge tool.*
...
* **[Far Manager](https://github.com/FarGroup/FarManager) ⭐ 2,203 | 🐛 154 | 🌐 C++ | 📅 2026-08-13** - *Text-based file and archive manager for Windows.*
...
* **[MilkyTracker](https://github.com/milkytracker/MilkyTracker) ⭐ 2,085 | 🐛 86 | 🌐 C++ | 📅 2026-06-22** - *Multi-platform music tracker inspired by FastTracker 2.*
...
* **[Nasm](https://github.com/netwide-assembler/nasm) ⭐ 3,282 | 🐛 59 | 🌐 Assembly | 📅 2026-07-07** - *Netwide Assembler for x86 architecture.*
* **AsmEdit** - *ASM Editor.*
...
* **[ScyllaHide](https://github.com/x64dbg/ScyllaHide) ⭐ 4,263 | 🐛 52 | 🌐 C++ | 📅 2024-06-04** - *Anti-(anti-debugger).*
...
* **[UPX](https://github.com/upx/upx) ⭐ 17,779 | 🐛 26 | 🌐 C++ | 📅 2026-08-14** - *Free, portable, and extendable executable packer.*
...
* **[Etcher](https://github.com/balena-io/etcher) ⭐ 34,156 | 🐛 684 | 🌐 TypeScript | 📅 2026-06-02** - *A cross-platform tool to flash OS images onto SD cards and USB.*
...
* **[Apktool](https://github.com/iBotPeaches/Apktool) ⭐ 25,285 | 🐛 77 | 🌐 Java | 📅 2026-08-11** - *Tool for decompiling and recompiling Android APK files.*
...
* **[XAPK Detector](https://github.com/horsicq/XAPKDetector) ⭐ 693 | 🐛 1 | 🌐 C++ | 📅 2026-08-14** - *Detects and handles XAPK files.*
...
* **[NS-USBloader](https://github.com/developersu/ns-usbloader) ⭐ 2,308 | 🐛 55 | 🌐 Java | 📅 2026-08-13** - *Nintendo Switch games installer using Awoo-Installer.*
...
* **[Logisim](https://github.com/logisim-evolution/logisim-evolution) ⭐ 7,433 | 🐛 142 | 🌐 Java | 📅 2026-08-14** - *Educational digital circuit simulator.*
* **[Arduino CLI](https://github.com/arduino/arduino-cli) ⭐ 4,989 | 🐛 258 | 🌐 Go | 📅 2026-08-14** - *Command-line interface for Arduino.*
...
* **[Sandboxie](https://github.com/sandboxie-plus/Sandboxie) ⭐ 19,158 | 🐛 739 | 🌐 C | 📅 2026-08-13** - *Enhanced version of the popular sandboxing program.*
* **[Cmake](https://github.com/Kitware/CMake) ⭐ 8,032 | 🐛 2 | 🌐 C | 📅 2026-08-14** - *C, C++ builder.*
* **[Npcap](https://github.com/nmap/npcap) ⭐ 3,568 | 🐛 241 | 🌐 C | 📅 2026-05-28** - *Packet capture library installer.*
* **[MSYS2](https://github.com/nmap/npcap) ⭐ 3,568 | 🐛 241 | 🌐 C | 📅 2026-05-28** - *Unix SDK installer for Windows.*
